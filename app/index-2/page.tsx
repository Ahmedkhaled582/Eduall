...
<section class="banner-two pt-80 position-relative overflow-hidden">
    ...
    <img src="/assets/images/shapes/shape8.png" alt="" class="shape three animation-rotation z-n1">
    <img src="/assets/images/shapes/shape8.png" alt="" class="shape five animation-scalation">
        ...
        <div class="row gy-5 align-items-center">
            <div class="col-xl-6">
                ...
                <div class="banner-content pe-md-4">
                    <div class="flex-align gap-8 mb-16" data-aos="fade-down">
                        ...
                        <h5 class="text-main-600 mb-0">Elevate Your Learning</h5>
                    </div>
                    
                    <h1 class="display2 mb-24 wow bounceInLeft">Learn, 
                        <span class="text-main-two-600 wow bounceInRight" data-wow-duration="2s" data-wow-delay=".5s">Grow, </span>
                        <span class="text-main-three-600 wow bounceInLeft" data-wow-duration="1s" data-wow-delay=".5s">Achieve</span>  And Succeed
                    </h1>
                    ...
                    <div class="buttons-wrapper flex-align flex-wrap gap-24 mt-40">
                        <a href="/course" class="btn btn-main rounded-pill flex-align gap-8" data-aos="fade-right">
                            Browse Courses
                            <i class="ph-bold ph-arrow-up-right d-flex text-lg"></i>
                        </a>
                        <a href="/about" class="btn btn-outline-main rounded-pill flex-align gap-8" data-aos="fade-left">
                            About Us
                            <i class="ph-bold ph-arrow-up-right d-flex text-lg"></i>
                        </a>
                    </div>
            ...
            <div class="col-xl-6">
                <div class="banner-thumb position-relative">
                    <img src="/assets/images/thumbs/banner-img-2.png" alt="" class="banner-thumb__img rounded-12" data-aos="fade-up">
                    
                    <img src="/assets/images/shapes/shape9.png" class="position-absolute inset-block-end-0 start-0 z-n1" alt="" data-tilt data-tilt-max="16" data-tilt-speed="500">
                    <img src="/assets/images/shapes/shape10.png" class="position-absolute inset-block-start-0 start-0 z-n1 showHideTwo" alt="" data-tilt data-tilt-max="16" data-tilt-speed="500" data-tilt-perspective="5000" data-tilt-startX="100" data-tilt-full-page-listening>
                </div>
            </div>
        </div>
    </div>
...
<section class="info py-40 bg-main-600">
    <div class="container">
        <div class="row gy-4">
            <div class="col-xl-3 col-sm-6"  data-aos="fade-up" data-aos-duration="200">
            ...
            <div class="col-xl-3 col-sm-6"  data-aos="fade-up" data-aos-duration="400">
                <div class="info-item animation-item flex-align gap-20">
                    <span class="w-60 h-60 flex-center bg-white text-main-600 text-28 rounded-circle flex-shrink-0">
            ...
            <div class="col-xl-3 col-sm-6"  data-aos="fade-up" data-aos-duration="600">
                <div class="info-item animation-item flex-align gap-20">
                    <span class="w-60 h-60 flex-center bg-white text-main-600 text-28 rounded-circle flex-shrink-0">
            ...
            <div class="col-xl-3 col-sm-6"  data-aos="fade-up" data-aos-duration="800">
                <div class="info-item animation-item flex-align gap-20">
                    <span class="w-60 h-60 flex-center bg-white text-main-600 text-28 rounded-circle flex-shrink-0">
...
<!-- ========================== Info Section End =================================== -->
 ...
 <section class="category py-120 position-relative z-1 mash-bg-main mash-bg-main-two mash-reverse">
    <div class="container">
        <div class="section-heading text-center">
            <div class="flex-align d-inline-flex gap-8 mb-16 wow bounceInDown">
                <span class="text-main-600 text-2xl d-flex"><i class="ph-bold ph-book"></i></span>
                <h5 class="text-main-600 mb-0">Categories</h5>
            </div>
            <h2 class="mb-24 wow bounceIn">Elevate Your Learning Experience</h2>
            <p class=" wow bounceInUp">Our platform is built on the principles of innovation, quality, and inclusivity, aiming to provide a seamless learning</p>
        </div>
        <div class="category-item-slider">
            <div class="category-item animation-item h-100 text-center px-16 py-32 rounded-12 bg-main-25 border border-neutral-30 hover-border-main-600 transition-2" data-aos="fade-up" data-aos-duration="200">
                <span class="w-96 h-96 flex-center d-inline-flex bg-white text-main-600 text-40 rounded-circle box-shadow-md mb-24">
                    <img src="/assets/images/icons/category-icon1.png" class="animate__flipInY" alt="">
                </span>
                <h4 class="display-four mb-16 text-neutral-700">Arts & Design</h4>
                <p class="text-neutral-500 text-lg text-line-2">Courses on nutrition, fitness training, yoga...</p>
                <a href="/courses" class="py-12 px-24 bg-white rounded-8 border border-neutral-30 mt-28 fw-semibold text-main-600 hover-bg-main-600 hover-text-white hover-border-main-600">
                    14 Course
                </a>
            </div>
            <div class="category-item animation-item h-100 text-center px-16 py-32 rounded-12 bg-main-two-25 border border-neutral-30 hover-border-main-two-600 transition-2" data-aos="fade-up" data-aos-duration="400">
                <span class="w-96 h-96 flex-center d-inline-flex bg-white text-main-600 text-40 rounded-circle box-shadow-md mb-24">
                    <img src="/assets/images/icons/category-icon2.png" class="animate__flipInY" alt="">
                </span>
                <h4 class="display-four mb-16 text-neutral-700">ArtsDesign</h4>
                <p class="text-neutral-500 text-lg text-line-2">Courses on nutrition, fitness training, yoga...</p>
                <a href="/courses" class="py-12 px-24 bg-white rounded-8 border border-neutral-30 mt-28 fw-semibold text-main-two-600 hover-bg-main-two-600 hover-text-white hover-border-main-two-600">
                    15 Course
                </a>
            </div>
            <div class="category-item animation-item h-100 text-center px-16 py-32 rounded-12 bg-main-three-25 border border-neutral-30 hover-border-main-three-600 transition-2" data-aos="fade-up" data-aos-duration="600">
                <span class="w-96 h-96 flex-center d-inline-flex bg-white text-main-three-600 text-40 rounded-circle box-shadow-md mb-24">
                    <img src="/assets/images/icons/category-icon3.png" class="animate__flipInY" alt="">
                </span>
                <h4 class="display-four mb-16 text-neutral-700">Data Science</h4>
                <p class="text-neutral-500 text-lg text-line-2">Courses on nutrition, fitness training, yoga...</p>
                <a href="/courses" class="py-12 px-24 bg-white rounded-8 border border-neutral-30 mt-28 fw-semibold text-main-three-600 hover-bg-main-three-600 hover-text-white hover-border-main-three-600">
                    14 Course
                </a>
            </div>
            <div class="category-item animation-item h-100 text-center px-16 py-32 rounded-12 bg-main-two-25 border border-neutral-30 hover-border-main-two-600 transition-2" data-aos="fade-up" data-aos-duration="800">
                <span class="w-96 h-96 flex-center d-inline-flex bg-white text-main-600 text-40 rounded-circle box-shadow-md mb-24">
                    <img src="/assets/images/icons/category-icon4.png" class="animate__flipInY" alt="">
                </span>
                <h4 class="display-four mb-16 text-neutral-700">Business & Finance</h4>
                <p class="text-neutral-500 text-lg text-line-2">Courses on nutrition, fitness training, yoga...</p>
                <a href="/courses" class="py-12 px-24 bg-white rounded-8 border border-neutral-30 mt-28 fw-semibold text-main-two-600 hover-bg-main-two-600 hover-text-white hover-border-main-two-600">
                    21 Course
                </a>
            </div>
            <div class="category-item animation-item h-100 text-center px-16 py-32 rounded-12 bg-main-three-25 border border-neutral-30 hover-border-main-three-600 transition-2" data-aos="fade-up" data-aos-duration="400">
                <span class="w-96 h-96 flex-center d-inline-flex bg-white text-main-three-600 text-40 rounded-circle box-shadow-md mb-24">
                    <img src="/assets/images/icons/category-icon3.png" class="animate__flipInY" alt="">
                </span>
                <h4 class="display-four mb-16 text-neutral-700">Data Science</h4>
            ...
            <div class="category-item animation-item h-100 text-center px-16 py-32 rounded-12 bg-main-two-25 border border-neutral-30 hover-border-main-two-600 transition-2" data-aos="fade-up" data-aos-duration="600">
                <span class="w-96 h-96 flex-center d-inline-flex bg-white text-main-600 text-40 rounded-circle box-shadow-md mb-24">
                    <img src="/assets/images/icons/category-icon2.png" class="animate__flipInY" alt="">
                </span>
                <h4 class="display-four mb-16 text-neutral-700">ArtsDesign</h4>
...
<section class="about-two py-120 position-relative z-1 bg-main-25">
    <div class="position-relative">
        <div class="container">
            <div class="row gy-xl-0 gy-5 flex-wrap-reverse align-items-center">
                <div class="col-xl-6 pe-xl-5">
                    <div class="about-two__thumb position-relative">
                        <img src="/assets/images/thumbs/about-two-img.png" class="rounded-16 cover-img  wow bounceIn" alt="" data-tilt data-tilt-max="10" data-tilt-speed="500" data-tilt-perspective="5000" data-tilt-full-page-listening>
                        
                        <span class="shadow-main-three w-80 h-80 flex-center bg-main-three-600 rounded-circle position-absolute inset-block-start-0 inset-inline-start-0 mt-40 ms--40 animation-upDown">
                            <img src="/assets/images/icons/bulb-icon.png" class="" alt="">
                        </span>

                        <div class="offer-message  two px-24 py-12 rounded-12 bg-white fw-medium box-shadow-lg flex-align d-inline-flex gap-16 animation-upDown">
                            <span class="flex-shrink-0 w-48 h-48 bg-purple-400 text-white text-2xl flex-center rounded-circle"><i class="ph ph-watch"></i></span>
                            <div>
                        ...
                        <div class="offer-message style-two  me-lg-0 me-24 px-24 py-12 rounded-12 bg-white fw-medium flex-align d-inline-flex gap-16 box-shadow-lg animation-upDown">
                            <span class="flex-shrink-0 w-48 h-48 bg-main-two-600 text-white text-2xl flex-center rounded-circle">
                        ...
                        <div class="position-absolute inset-block-end-0 inset-inline-end-0 me-lg-0 me-24 px-24 py-12 rounded-12 bg-white fw-medium flex-align d-inline-flex gap-16 box-shadow-lg animation-upDown">
                            <div class="text-center">
                                <img src="/assets/images/icons/circle-progress.png" class="d-sm-flex d-none mb-24" alt="">
                                <h6 class="mb-4 text-neutral-700 text-2xl">Excelent</h6>
                                <span class="text-sm text-neutral-500">90% Satisfied Clients</span>
                            </div>
                        </div>
                ...
                <div class="col-xl-6">
                    <div class="about-two-content">
                        <div class="mb-40">
                            ...
                            <h2 class="mb-24 wow bounceIn">Over 16 Years in Distant learning for Skill Development</h2>
                        ...
                        <div class="grid-cols-2">
                            <div class="flex-align align-items-start gap-20 animation-item" data-aos="fade-up" data-aos-duration="600">
                                <span class="flex-shrink-0 w-60 h-60 flex-center d-inline-flex bg-white text-main-600 text-40 rounded-circle box-shadow-md">
                                    <img src="/assets/images/icons/choose-us-icon1.png" class="animate__swing" alt="">
                                </span>
                                <div class="flex-grow-1">
                                    <h6 class="text-neutral-800 text-xl fw-medium mb-8">Academic Excellence</h6>
                                    <p class="text-neutral-500 text-line-2">Through our curated courses, interactive content</p>
                                </div>
                            </div>
                            <div class="flex-align align-items-start gap-20 animation-item" data-aos="fade-up" data-aos-duration="800">
                                ...
                                <div class="flex-grow-1">
                                    <h6 class="text-neutral-800 text-xl fw-medium mb-8">Course Offerings</h6>
                                    <p class="text-neutral-500 text-line-2">Personalized learning paths, we empower learners to acquire </p>
                                </div>
                            </div>
                            <div class="flex-align align-items-start gap-20 animation-item" data-aos="fade-up" data-aos-duration="1000">
                                ...
                                <div class="flex-grow-1">
                                    <h6 class="text-neutral-800 text-xl fw-medium mb-8">Innovative Learning </h6>
                                    <p class="text-neutral-500 text-line-2">Immerse yourself in an innovative learning</p>
                                </div>
                            </div>
                            <div class="flex-align align-items-start gap-20 animation-item" data-aos="fade-up" data-aos-duration="1200">
                                ...
                                <div class="flex-grow-1">
                                    <h6 class="text-neutral-800 text-xl fw-medium mb-8">Sustainability Initiative</h6>
                                    <p class="text-neutral-500 text-line-2">Be part of a university that cares about the planet. </p>
                                </div>
                            </div>
                        </div>
    
                        <div class="pt-40 border-top border-neutral-50 mt-40 border-dashed border-0">
                            <a href="/course" class="btn btn-main rounded-pill flex-align d-inline-flex gap-8">
                                Read More
                                <i class="ph-bold ph-arrow-up-right d-flex text-lg"></i>
                            </a>
                        </div>
...
<section class="features-two half-bg py-120 position-relative overflow-hidden">
    ...
    <div class="container">
        <div class="section-heading style-flex">
            <div class="section-heading__inner">
                <h2 class="mb-24 wow bounceInLeft">Build better growth skills, faster. Ignite Your Learning Journey</h2>
            </div>
            <div class="section-heading__content wow bounceInRight">
                <p class="text-line-2">Explore new skills, deepen existing passions, and get lost in creativity. What you find just might...</p>
                <a href="/course-list-view" class="item-hover__text flex-align d-inline-flex gap-8 text-main-600 mt-24 hover-text-decoration-underline transition-1 fw-semibold">
                    Read More
        ...
        <div class="row gy-4">
            <div class="col-lg-4 col-sm-6 col-xs-6" data-aos="fade-up" data-aos-duration="200">
                <div class="text-center features-item item-hover animation-item bg-white border border-neutral-30 rounded-16 transition-1 hover-bg-main-600 hover-border-main-600">
                    <span class="mb-32 w-110 h-110 flex-center d-inline-flex bg-main-25 rounded-circle">
                        <img src="/assets/images/icons/features-two-icon1.png" class="animate__bounce" alt="">
                    </span>
                    <h4 class="mb-16 transition-1 item-hover__text">Learn the latest skills</h4>
                    <p class="transition-1 item-hover__text text-line-2">Quality education shouldn't break the bank. We offer competitive pricing and payment options</p>
                    <span class="item-hover__bg w-48 h-1 bg-neutral-500 mt-32"></span>
                </div>
            </div>
            <div class="col-lg-4 col-sm-6 col-xs-6" data-aos="fade-up" data-aos-duration="400">
                <div class="text-center features-item item-hover animation-item bg-white border border-neutral-30 rounded-16 transition-1 hover-bg-main-600 hover-border-main-600">
                    <span class="mb-32 w-110 h-110 flex-center d-inline-flex bg-main-25 rounded-circle">
                        <img src="/assets/images/icons/features-two-icon2.png" class="animate__bounce" alt="">
                    </span>
                    <h4 class="mb-16 transition-1 item-hover__text">Get ready for a career</h4>
                    <p class="transition-1 item-hover__text text-line-2">Engage in dynamic and interactive learning experiences. Our courses are designed</p>
                    <span class="item-hover__bg w-48 h-1 bg-neutral-500 mt-32"></span>
                </div>
            </div>
            <div class="col-lg-4 col-sm-6 col-xs-6" data-aos="fade-up" data-aos-duration="600">
                <div class="text-center features-item item-hover animation-item bg-white border border-neutral-30 rounded-16 transition-1 hover-bg-main-600 hover-border-main-600">
                    <span class="mb-32 w-110 h-110 flex-center d-inline-flex bg-main-25 rounded-circle">
                        <img src="/assets/images/icons/features-two-icon3.png" class="animate__bounce" alt="">
                    </span>
                    <h4 class="mb-16 transition-1 item-hover__text">Earn a Certificate</h4>
                    <p class="transition-1 item-hover__text text-line-2">Join a vibrant and supportive learning community. Connect with fellow learners</p>
                    <span class="item-hover__bg w-48 h-1 bg-neutral-500 mt-32"></span>
                </div>
            </div>
        </div>
...
<section class="certificate-two py-120 position-relative z-1 mash-bg-main mash-bg-main-two mash-reverse">
    <div class="section-heading text-center">
        <h2 class="mb-24 wow bounceIn">Skills Certificate from the EduAll</h2>
        <p class=" wow bounceInUp">Online courses certification section design for showcase your certificate program features.</p>
    </div>
    <div class="position-relative">
        <div class="container">
            <div class="row align-items-center gy-4">
                <div class="col-lg-6 pe-lg-5">
                    <div class="certificate-two-item animation-item border-bottom border-neutral-50 border-dashed border-0 mb-28 pb-28" data-aos="fade-up" data-aos-duration="200">
                        <div class="flex-align gap-20 mb-12">
                            <span class="w-52 h-52 flex-center d-inline-flex bg-main-25 rounded-circle text-main-600 text-2xl">
                                <i class="animate__wobble ph-bold ph-medal"></i>
                            </span>
                            <h5 class="mb-0">Learn from Industry Experts</h5>
                        </div>
                        <p class="text-neutral-700 text-line-2">Lorem ipsum dolor sit amet, conse ctetur adipisc amus ac iaculis arcu.</p>
                    </div>
                    <div class="certificate-two-item animation-item border-bottom border-neutral-50 border-dashed border-0 mb-28 pb-28" data-aos="fade-up" data-aos-duration="400">
                        <div class="flex-align gap-20 mb-12">
                            <span class="w-52 h-52 flex-center d-inline-flex bg-main-25 rounded-circle text-main-600 text-2xl">
                                <i class="animate__wobble ph-bold ph-clock"></i>
                            </span>
                            <h5 class="mb-0">Learn Anytime, Anywhere</h5>
                        </div>
                        <p class="text-neutral-700 text-line-2">Lorem ipsum dolor sit amet, conse ctetur adipisc amus ac iaculis arcu.</p>
                    </div>
                    <div class="certificate-two-item animation-item border-bottom border-neutral-50 border-dashed border-0 mb-28 pb-28" data-aos="fade-up" data-aos-duration="600">
                        <div class="flex-align gap-20 mb-12">
                            <span class="w-52 h-52 flex-center d-inline-flex bg-main-25 rounded-circle text-main-600 text-2xl">
                                <i class="animate__wobble ph-bold ph-star"></i>
                            </span>
                            <h5 class="mb-0">Free Resources</h5>
                        </div>
                        <p class="text-neutral-700 text-line-2">Lorem ipsum dolor sit amet, conse ctetur adipisc amus ac iaculis arcu.</p>
                    </div>
                    <div class="certificate-two-item animation-item" data-aos="fade-up" data-aos-duration="800">
                        <div class="flex-align gap-20 mb-12">
                            <span class="w-52 h-52 flex-center d-inline-flex bg-main-25 rounded-circle text-main-600 text-2xl">
                                <i class="animate__wobble ph-bold ph-chart-line-up"></i>
                            </span>
                            <h5 class="mb-0">Skill-based Learning</h5>
                        </div>
                        <p class="text-neutral-700 text-line-2">Lorem ipsum dolor sit amet, conse ctetur adipisc amus ac iaculis arcu.</p>
                    </div>
                </div>
...
<section class="explore-course py-120 bg-main-25 position-relative z-1">
    ...
    <div class="container">
        <div class="section-heading text-center">
            <div class="flex-align d-inline-flex gap-8 mb-16 wow bounceInDown">
                <span class="text-main-600 text-2xl d-flex"><i class="ph-bold ph-book"></i></span>
                <h5 class="text-main-600 mb-0">Popular Courses</h5>
            </div>
            <h2 class="mb-24 wow bounceIn">Pick A Course To Get Started</h2>
            <p class=" wow bounceInUp">Our platform is built on the principles of innovation, quality, and inclusivity, aiming to provide a seamless learning</p>
        </div>
            ...
            <div class="course-item__content position-relative">
                ...
                <div class="">
                    <div class="mb-16 flex-align gap-16 flex-wrap">
                        <a href="/course" class="py-8 px-20 rounded-pill flex-align gap-8 text-main-600 fw-medium bg-main-25 hover-bg-main-600 hover-text-white">
                            <span class="text-xl d-flex">
                                <i class="ph-bold ph-squares-four"></i>
                            </span>
                            Marketing
                        </a>
                        <a href="/course" class="py-8 px-20 rounded-pill flex-align gap-8 text-main-three-600 fw-medium bg-main-three-25 hover-bg-main-three-600 hover-text-white">
                            <span class="text-xl d-flex">
                                <i class="ph-bold ph-squares-four"></i>
                            </span>
                            Beginner
                    ...
                    <h4 class="mb-28">
                        <a href="/course-details" class="link text-line-2">Introduction to Digital Marketing</a>
                    </h4>
                    <div class="flex-align gap-28 flex-wrap mb-16">
                        <div class="flex-align gap-8">
                            ...
                            <span class="text-neutral-700 text-lg fw-medium">20</span>
                        </div>
                        <div class="flex-align gap-8">
                            <span class="text-neutral-700 text-2xl d-flex"><i class="ph-bold ph-clock"></i></span>
                            <span class="text-neutral-700 text-lg fw-medium">9h 36m</span>
                        </div>
                        <div class="flex-align gap-8">
                            <span class="text-neutral-700 text-2xl d-flex"><i class="ph-bold ph-users"></i></span>
                            <span class="text-neutral-700 text-lg fw-medium">1.5K</span>
                        </div>
                    </div>  
                </div>
        ...
        <div class="course-item bg-white rounded-16 p-12 h-100 box-shadow-md">
            ...
            <div class="course-item__content position-relative">
                ...
                <div class="">
                    ...
                    <h4 class="mb-28">
                        <a href="/course-details" class="link text-line-2">Mastering Python : From Zero to Hero</a>
                    </h4>
                    <div class="flex-align gap-28 flex-wrap mb-16">
                        <div class="flex-align gap-8">
                            <span class="text-neutral-700 text-2xl d-flex"><i class="ph-bold ph-video-camera"></i></span>
        ...
        <div class="course-item bg-white rounded-16 p-12 h-100 box-shadow-md">
            ...
            <div class="course-item__content position-relative">
                ...
                <div class="">
                    ...
                    <h4 class="mb-28">
                        <a href="/course-details" class="link text-line-2">Beginner's Guide to Adobe Photoshop</a>
                    </h4>
                    <div class="flex-align gap-28 flex-wrap mb-16">
                        <div class="flex-align gap-8">
                            <span class="text-neutral-700 text-2xl d-flex"><i class="ph-bold ph-video-camera"></i></span>
        ...
        <div class="course-item bg-white rounded-16 p-12 h-100 box-shadow-md">
            ...
            <div class="course-item__content position-relative">
                ...
                <div class="">
                    ...
                    <h4 class="mb-28">
                        <a href="/course-details" class="link text-line-2">The Art of Public Speaking online Course</a>
                    </h4>
                    <div class="flex-align gap-28 flex-wrap mb-16">
                        <div class="flex-align gap-8">
                            <span class="text-neutral-700 text-2xl d-flex"><i class="ph-bold ph-video-camera"></i></span>
        ...
        <div class="course-item bg-white rounded-16 p-12 h-100 box-shadow-md">
            ...
            <div class="course-item__content position-relative">
                ...
                <div class="">
                    ...
                    <h4 class="mb-28">
                        <a href="/course-details" class="link text-line-2">Introduction to Machine Learning AI</a>
                    </h4>
                    <div class="flex-align gap-28 flex-wrap mb-16">
                        <div class="flex-align gap-8">
                            <span class="text-neutral-700 text-2xl d-flex"><i class="ph-bold ph-video-camera"></i></span>
        ...
        <div class="course-item bg-white rounded-16 p-12 h-100 box-shadow-md">
            ...
            <div class="course-item__content position-relative">
                ...
                <div class="">
                    ...
                    <h4 class="mb-28">
                        <a href="/course-details" class="link text-line-2">Yoga for Wellness: A Comprehensive Guide</a>
                    </h4>
                    <div class="flex-align gap-28 flex-wrap mb-16">
                        <div class="flex-align gap-8">
                            <span class="text-neutral-700 text-2xl d-flex"><i class="ph-bold ph-video-camera"></i></span>
...
<div class="text-center">
    <a href="/course" class="btn btn-outline-main rounded-pill flex-align d-inline-flex gap-8 mt-40">
        See All Courses
        <i class="ph-bold ph-arrow-up-right d-flex text-lg"></i>
    </a>
</div>
                ...
                <div class="row gy-4 align-items-center">
                    <div class="col-lg-6">
                        <div class="join-community__content">
                            <div class="mb-40">
                                <h2 class="mb-24 wow bounceIn">Join the EduAll Community: Start Now</h2>
                                <p class="text-neutral-500 text-line-2 wow bounceInUp">Ready to explore our courses firsthand? Sign up for a free trial lesson today and get a taste of the engaging.</p>
                            </div>

                            <form action="#">
                                <div class="mb-24 position-relative" data-aos="fade-up-left" data-aos-duration="400">
                                    <input type="text" class="bg-white text-black border border-transparent focus-border-main-600 h-48 rounded-pill px-16 ps-60 outline-0 w-100" placeholder="Enter Name...">
                                ...
                                <div class="mb-24 position-relative" data-aos="fade-up-left" data-aos-duration="600">
                                    <input type="email" class="bg-white text-black border border-transparent focus-border-main-600 h-48 rounded-pill px-16 ps-60 outline-0 w-100" placeholder="Enter Email">
                                    <span class="bg-white text-neutral-200 text-2xl flex-center w-48 h-48 rounded-circle border border-main-25 border-4 position-absolute inset-inline-start-0 top-50 translate-middle-y">
                                        <i class="ph-bold ph-envelope-open"></i>
                                    </span>
                                </div>
                                <div class="mb-24 position-relative" data-aos="fade-up-left" data-aos-duration="800">
                                    <select class="bg-white text-black border border-transparent focus-border-main-600 h-48 rounded-pill px-16 ps-60 outline-0 w-100 text-neutral-300">
                    ...
                    <div class="col-lg-6">
                        <div class="join-community__thumb text-end position-relative">
                            <img src="/assets/images/thumbs/join-community-img.png" alt="" class="wow bounceIn" data-tilt data-tilt-max="12" data-tilt-speed="500" data-tilt-perspective="5000" data-tilt-full-page-listening>
            ...
            <div class="row gy-5">
                <div class="col-lg-3 col-sm-6 col-xs-6"  data-aos="fade-up" data-aos-duration="400">
                    <div class="footer-item">
                        ...
                        <ul class="footer-menu">
                            <li class="mb-16">
                                <a href="/about" class="text-white hover-text-main-600 hover-text-decoration-underline">About us</a>
                            </li>
                            <li class="mb-16">
                                <a href="/courses" class="text-white hover-text-main-600 hover-text-decoration-underline">Courses</a>
                            </li>
                            <li class="mb-16">
                                <a href="/instructor" class="text-white hover-text-main-600 hover-text-decoration-underline">Instructor</a>
                            </li>
                            <li class="mb-16">
                                <a href="/faq" class="text-white hover-text-main-600 hover-text-decoration-underline">FAQs</a>
                            </li>
                            <li class="mb-0">
                                <a href="/blog" class="text-white hover-text-main-600 hover-text-decoration-underline">Blogs</a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 col-xs-6"  data-aos="fade-up" data-aos-duration="600">
                    <div class="footer-item">
                        ...
                        <ul class="footer-menu">
                            <li class="mb-16">
                                <a href="/courses" class="text-white hover-text-main-600 hover-text-decoration-underline">UI/UX Design</a>
                            </li>
                            <li class="mb-16">
                                <a href="/courses" class="text-white hover-text-main-600 hover-text-decoration-underline">Web Development</a>
                            </li>
                            <li class="mb-16">
                                <a href="/courses" class="text-white hover-text-main-600 hover-text-decoration-underline">Python Development</a>
                            </li>
                            <li class="mb-16">
                                <a href="/courses" class="text-white hover-text-main-600 hover-text-decoration-underline">Digital Marketing</a>
                            </li>
                            <li class="mb-16">
                                <a href="/courses" class="text-white hover-text-main-600 hover-text-decoration-underline">Graphic Design</a>
                            </li>
                        </ul>
                    </div>
                </div>
