...
<!-- =====message nab end======== -->
        <!-- =========message profile start=========== -->
            <div class="px-24 py-24">
                <div class="d-flex align-items-center gap-16 justify-content-between flex-wrap mb-24">
                    <h4 class="text-neutral-500 fw-semibold">Wishlist</h4>
                    <div>
                        <div class="row gy-4">
    
    <div class="col-xl-3 col-md-6 wow fadeInUp" data-aos="fade-up" data-aos-duration="600">
    ...
    <div class="col-xl-3 col-md-6 wow fadeInUp" data-aos="fade-up" data-aos-duration="700">
        <div class="course-item bg-white rounded-16 p-12 h-100 box-shadow-md">
            <div class="course-item__thumb rounded-12 overflow-hidden position-relative">
                <a href="/course-details" class="w-100 h-100">
    ...
    <div class="col-xl-3 col-md-6 wow fadeInUp" data-aos="fade-up" data-aos-duration="800">
        <div class="course-item bg-white rounded-16 p-12 h-100 box-shadow-md">
            <div class="course-item__thumb rounded-12 overflow-hidden position-relative">
                <a href="/course-details" class="w-100 h-100">
    ...
    <div class="col-xl-3 col-md-6 wow fadeInUp" data-aos="fade-up" data-aos-duration="900">
        <div class="course-item bg-white rounded-16 p-12 h-100 box-shadow-md">
            <div class="course-item__thumb rounded-12 overflow-hidden position-relative">
                <a href="/course-details" class="w-100 h-100">
