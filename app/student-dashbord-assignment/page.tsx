...
<!-- ========Dashdord Sidebar end======== -->
            ...
            <div class="w-100 overflow-y-auto">
                ...
                <div class="px-24 py-24 bg-white rounded-10">
                    <div class="">
                        <div class="d-flex align-items-center gap-16 justify-content-between mb-24">
                            <h6 class="mb-0">My Quiz Attempts</h6>
                            ...
                            <table id="example-five" class="display min-w-max w-100">
                                ...
                                <tbody>
                                    ...
                                    <tr class="hover-bg-neutral-20 transition-03">
                                        <td class="py-28 px-20 shadow-none line-height-105 text-14 fw-normal">
                                            Notating Scales and Piano Keys (Treble)
                                        </td>
                                        <td class="text-14 fw-normal py-28 px-20 shadow-none line-height-105">Excel for Beginners</td>
                                        <td class="py-28 px-20 shadow-none line-height-105">36</td>
                                        ...
                                        <td class="py-28 px-20 shadow-none line-height-105">
                                            <div class="d-flex align-items-center gap-12  justify-content-end">
                                                <button type="button" class="text-24 text-neutral-500">
                                    ...
                                    <tr class="hover-bg-neutral-20 transition-03">
                                        ...
                                        <td class="text-14 fw-normal py-28 px-20 shadow-none line-height-105">Introduction to Python Programming</td>
                                        <td class="py-28 px-20 shadow-none line-height-105">37</td>
                                        <td class="py-28 px-20 shadow-none line-height-105">4</td>
                                        <td class="py-28 px-20 shadow-none line-height-105">
                                            <div class="d-flex align-items-center gap-12  justify-content-end">
                                                <button type="button" class="text-24 text-neutral-500">
                                    ...
                                    <tr class="hover-bg-neutral-20 transition-03">
                                        ...
                                        <td class="text-14 fw-normal py-28 px-20 shadow-none line-height-105">Photography Basics</td>
                                        <td class="py-28 px-20 shadow-none line-height-105">35</td>
                                        <td class="py-28 px-20 shadow-none line-height-105">4</td>
                                        <td class="py-22 shadow-none line-height-105">
                                            <span class="d-flex align-items-center gap-4 text-12 fw-medium px-12 py-9 text-main-500 border-main-500 border rounded-pill flex-wrap">
                                                Submit
                                    ...
                                    <tr class="hover-bg-neutral-20 transition-03">
                                        ...
                                        <td class="text-14 fw-normal py-28 px-20 shadow-none line-height-105">Entrepreneurship 101</td>
                                        <td class="py-28 px-20 shadow-none line-height-105">41</td>
                                    ...
                                    <tr class="hover-bg-neutral-20 transition-03">
                                        ...
                                        <td class="text-14 fw-normal py-28 px-20 shadow-none line-height-105">Leadership and Management Essentials</td>
                                        <td class="py-28 px-20 shadow-none line-height-105">43</td>
                                        <td class="py-28 px-20 shadow-none line-height-105">4</td>
                                        <td class="py-28 px-20 shadow-none line-height-105">
                                            <div class="d-flex align-items-center gap-12  justify-content-end">
                                                <button type="button" class="text-24 text-neutral-500">
                                    ...
                                    <tr class="hover-bg-neutral-20 transition-03">
                                        ...
                                        <td class="text-14 fw-normal py-28 px-20 shadow-none line-height-105">Creative Writing Workshop</td>
                                        <td class="py-28 px-20 shadow-none line-height-105">39</td>
                                        <td class="py-28 px-20 shadow-none line-height-105">4</td>
                                        <td class="py-28 px-20 shadow-none line-height-105">
                                            <div class="d-flex align-items-center gap-12  justify-content-end">
                                                <button type="button" class="text-24 text-neutral-500">
                                    ...
                                    <tr class="hover-bg-neutral-20 transition-03">
                                        ...
                                        <td class="text-14 fw-normal py-28 px-20 shadow-none line-height-105">Digital Marketing 101</td>
                                        <td class="py-28 px-20 shadow-none line-height-105">44</td>
                                    ...
                                    <tr class="hover-bg-neutral-20 transition-03">
                                        ...
                                        <td class="text-14 fw-normal py-28 px-20 shadow-none line-height-105">Adobe Photoshop Essentials</td>
                                        <td class="py-28 px-20 shadow-none line-height-105">45</td>
                                        <td class="py-28 px-20 shadow-none line-height-105">6</td>
                                        <td class="py-22 shadow-none line-height-105">
                                            <span class="d-flex align-items-center gap-4 text-12 fw-medium px-12 py-9 text-main-500 border-main-500 border rounded-pill flex-wrap">
                                                Submit
                                    ...
                                    <tr class="hover-bg-neutral-20 transition-03">
                                        ...
                                        <td class="text-14 fw-normal py-28 px-20 shadow-none line-height-105">Social Media Strategy</td>
                                        <td class="py-28 px-20 shadow-none line-height-105">40</td>
                                    ...
                                    <tr class="hover-bg-neutral-20 transition-03">
                                        ...
                                        <td class="text-14 fw-normal py-28 px-20 shadow-none line-height-105">Introduction to Python</td>
                                        <td class="py-28 px-20 shadow-none line-height-105">34</td>
                                        <td class="py-28 px-20 shadow-none line-height-105">2</td>
                                        <td class="py-28 px-20 shadow-none line-height-105">
                                            <div class="d-flex align-items-center gap-12  justify-content-end">
                                                <button type="button" class="text-24 text-neutral-500">
                                    ...
                                    <tr class="hover-bg-neutral-20 transition-03">
                                        ...
                                        <td class="text-14 fw-normal py-28 px-20 shadow-none line-height-105">Public Speaking Mastery</td>
                                        <td class="py-28 px-20 shadow-none line-height-105">42</td>
                                    ...
                                    <tr class="hover-bg-neutral-20 transition-03">
                                        ...
                                        <td class="text-14 fw-normal py-28 px-20 shadow-none line-height-105">Web Development Bootcamp</td>
                                        <td class="py-28 px-20 shadow-none line-height-105">38</td>
