        ...
        <div class="row gy-5 align-items-center">
            ...
            <div class="col-xl-6">
                <div class="banner-thumb position-relative">
                    <img src="/assets/images/thumbs/banner-img.png" alt="" class="banner-thumb__img rounded-12 wow bounceIn" data-wow-duration="3s" data-wow-delay=".5s" data-tilt data-tilt-max="12" data-tilt-speed="500" data-tilt-perspective="5000" data-tilt-full-page-listening data-tilt-scale="1.02">
        ...
        <div class="features-slider">
            <div class="px-8" data-aos="zoom-in" data-aos-duration="400">
                <div class="features-item item-hover animation-item bg-main-25 border border-neutral-30 rounded-16 transition-1 hover-bg-main-600 hover-border-main-600">
                    ...
                    <a href="/course-list-view" class="item-hover__text flex-align gap-8 text-main-600 mt-24 hover-text-decoration-underline transition-1">
                        View Category
    ...
    <div class="container">
        <div class="section-heading text-center style-flex gap-24">
            ...
            <div class="section-heading__content">
                ...
                <a href="/course-list-view" class="item-hover__text flex-align gap-8 text-main-600 mt-24 hover-text-decoration-underline transition-1" tabindex="0">
                    See All Course
                    <i class="ph ph-arrow-right"></i>
                </a>
            </div>
                ...
                <div class="col-xl-6">
                    <div class="about-content">
                        ...
                        <div class="flex-align flex-wrap gap-32 pt-40 border-top border-neutral-50 mt-40 border-dashed border-0" data-aos="fade-left" data-aos-duration="600">
                            <a href="/course" class="btn btn-main rounded-pill flex-align gap-8">
                                Read More
                                <i class="ph-bold ph-arrow-up-right d-flex text-lg"></i>
                            </a>
