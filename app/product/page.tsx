        ...
        <div className="row justify-content-center">
            <div className="col-lg-8">
                <div className="breadcrumb__wrapper">
                    <h1 className="breadcrumb__title display-4 fw-semibold text-center"> Products</h1>
                    <ul className="breadcrumb__list d-flex align-items-center justify-content-center gap-4">
                        ...
                        <li className="breadcrumb__item"> 
                            <span className="text-main-two-600"> Products </span> 
                        </li>
                    </ul>
                </div>
            </div>
                    ...
                    <div className="sidebar rounded-12 bg-white p-32 box-shadow-md">
                        <form action="#">
                            ...
                            <div className="position-relative">
                                ...
                                <button type="submit" className="text-xl position-absolute top-50 translate-middle-y inset-inline-end-0 me-4  w-40 h-40 bg-main-600 d-flex align-items-center justify-content-center text-white rounded-circle hover-bg-main-700">
                            ...
                            <div className="d-flex flex-column gap-32">
                                <div className="col-sm-12">
                                    ...
                                    <div className="d-flex flex-column gap-16">
                                        ...
                                        <div className="form-check common-check common-radio mb-0">
                                            <input className="form-check-input" type="radio" name="gender" id="kids" />
                                            <label className="form-check-label fw-normal flex-grow-1" htmlFor="kids">kids</label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="">
                                    ...
                                    <div className="d-flex flex-column gap-16">
                                        <div className="form-check common-check mb-0">
                                            <input className="form-check-input bg-main-25" type="checkbox" name="tutorType" id="All" />
                                            <label className="form-check-label fw-normal flex-grow-1" htmlFor="All">All</label>
                                        </div>
                                        <div className="form-check common-check mb-0">
                                            <input className="form-check-input bg-main-25" type="checkbox" name="tutorType" id="Shoes" />
                                            <label className="form-check-label fw-normal flex-grow-1" htmlFor="Shoes">Shoes</label>
                                        </div>
                                        <div className="form-check common-check mb-0">
                                            <input className="form-check-input bg-main-25" type="checkbox" name="tutorType" id="Apparel" />
                                            <label className="form-check-label fw-normal flex-grow-1" htmlFor="Apparel">Apparel</label>
                                        </div>
                                        <div className="form-check common-check mb-0">
                                            <input className="form-check-input bg-main-25" type="checkbox" name="tutorType" id="Accessories" />
                                            <label className="form-check-label fw-normal flex-grow-1" htmlFor="Accessories">Accessories</label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="">
                                    ...
                                    <div className="color-list d-flex flex-wrap align-items-center gap-12">
                                        <button type="button" className="color-list__button w-24 h-24 bg-color-black rounded-circle"></button>
                                        ...
                                        <button type="button" className="color-list__button w-24 h-24 bg-color-info rounded-circle"></button>
                                        <button type="button" className="color-list__button w-24 h-24 bg-color-light-green rounded-circle"></button>
                                        <button type="button" className="color-list__button w-24 h-24 bg-color-yellow rounded-circle"></button>
                                        <button type="button" className="color-list__button w-24 h-24 bg-color-danger rounded-circle"></button>
                                        <button type="button" className="color-list__button w-24 h-24 bg-color-blue rounded-circle"></button>
                                        <button type="button" className="color-list__button w-24 h-24 bg-color-paste rounded-circle"></button>
                                ...
                                <div className="">
                                    ...
                                    <div className="custom--range style-two">
                    ...
                    <div className="row gy-4">
                        <div className="col-md-4 col-sm-6 col-xs-6">
                            <div className="scale-hover-item bg-white rounded-16 p-12 h-100 box-shadow-md">
                                <div className="course-item__thumb rounded-12 bg-main-25 overflow-hidden position-relative max-h-unset min-h-252">
                                    <a href="/product-details" className="w-100 h-100 d-flex justify-content-center align-items-center min-h-inherit">
                                        <img src="/assets/images/thumbs/product-img1.png" alt="Course Image" className="scale-hover-item__img rounded-12 transition-2" />
                                    </a>
                                ...
                                <div className="pt-32 pb-24 px-16 position-relative">
                                    <div className="">
                                        <div className="d-flex align-items-center justify-content-between mb-16">
                                            <h5 className="mb-0">
                                                <a href="/product-details" className="link text-line-1">Nike Air Force</a>
                                            </h5>
                                            <div className="flex-shrink-0 d-flex gap-4">
                                                <div className="d-flex flex-wrap align-items-center">
                                                    <button type="button" className="w-16 h-16 border border-2 border-white ms--6 bg-color-blue rounded-circle"></button>
                                                    <button type="button" className="w-16 h-16 border border-2 border-white ms--6 bg-color-light-green rounded-circle"></button>
                                                    <button type="button" className="w-16 h-16 border border-2 border-white ms--6 bg-color-danger rounded-circle"></button>
                                                </div>
                        ...
                        <div className="col-md-4 col-sm-6 col-xs-6">
                            <div className="scale-hover-item bg-white rounded-16 p-12 h-100 box-shadow-md">
                                <div className="course-item__thumb rounded-12 bg-main-25 overflow-hidden position-relative max-h-unset min-h-252">
                                    <a href="/product-details" className="w-100 h-100 d-flex justify-content-center align-items-center min-h-inherit">
                                        <img src="/assets/images/thumbs/product-img2.png" alt="Course Image" className="scale-hover-item__img rounded-12 transition-2" />
                                    </a>
                                    <div className="position-absolute inset-block-start-0 inset-inline-start-0 w-100 d-flex align-items-center justify-content-between p-16">
                                ...
                                <div className="pt-32 pb-24 px-16 position-relative">
                                    <div className="">
                                        <div className="d-flex align-items-center justify-content-between mb-16">
                                            <h5 className="mb-0">
                                                <a href="/product-details" className="link text-line-1">Athletic Sneaker</a>
                                            </h5>
                                            <div className="flex-shrink-0 d-flex gap-4">
                                                <div className="d-flex flex-wrap align-items-center">
                                                    <button type="button" className="w-16 h-16 border border-2 border-white ms--6 bg-color-blue rounded-circle"></button>
                        ...
                        <div className="col-md-4 col-sm-6 col-xs-6">
                            <div className="scale-hover-item bg-white rounded-16 p-12 h-100 box-shadow-md">
                                <div className="course-item__thumb rounded-12 bg-main-25 overflow-hidden position-relative max-h-unset min-h-252">
                                    <a href="/product-details" className="w-100 h-100 d-flex justify-content-center align-items-center min-h-inherit">
                                        <img src="/assets/images/thumbs/product-img3.png" alt="Course Image" className="scale-hover-item__img rounded-12 transition-2" />
                                    </a>
                                    <div className="position-absolute inset-block-start-0 inset-inline-start-0 w-100 d-flex align-items-center justify-content-between p-16">
                                        <button className="add-to-cart active-scale-08 w-40 h-40 rounded-8 d-flex justify-content-center align-items-center bg-white box-shadow-md text-neutral-500 text-lg hover-bg-main-100 hover-text-main-600 transition-2 ms-auto">
                                            <i className="ph ph-shopping-cart"></i>
                                ...
                                <div className="pt-32 pb-24 px-16 position-relative">
                                    <div className="">
                                        <div className="d-flex align-items-center justify-content-between mb-16">
                                            <h5 className="mb-0">
                                                <a href="/product-details" className="link text-line-1">Dressy Boots</a>
                                            </h5>
                                            <div className="flex-shrink-0 d-flex gap-4">
                                                <div className="d-flex flex-wrap align-items-center">
                                                    <button type="button" className="w-16 h-16 border border-2 border-white ms--6 bg-color-blue rounded-circle"></button>
                        ...
                        <div className="col-md-4 col-sm-6 col-xs-6">
                            <div className="scale-hover-item bg-white rounded-16 p-12 h-100 box-shadow-md">
                                <div className="course-item__thumb rounded-12 bg-main-25 overflow-hidden position-relative max-h-unset min-h-252">
                                    <a href="/product-details" className="w-100 h-100 d-flex justify-content-center align-items-center min-h-inherit">
                                        <img src="/assets/images/thumbs/product-img4.png" alt="Course Image" className="scale-hover-item__img rounded-12 transition-2" />
                                    </a>
                                    <div className="position-absolute inset-block-start-0 inset-inline-start-0 w-100 d-flex align-items-center justify-content-between p-16">
                                        <span className="py-8 px-16 bg-success-600 rounded-8 text-white">New</span>
                                        <button className="add-to-cart active-scale-08 w-40 h-40 rounded-8 d-flex justify-content-center align-items-center bg-white box-shadow-md text-neutral-500 text-lg hover-bg-main-100 hover-text-main-600 transition-2 ms-auto">
                                            <i className="ph ph-shopping-cart"></i>
                                        </button>
                                    </div>
                                ...
                                <div className="pt-32 pb-24 px-16 position-relative">
                                    <div className="">
                                        <div className="d-flex align-items-center justify-content-between mb-16">
                                            <h5 className="mb-0">
                                                <a href="/product-details" className="link text-line-1">Popular Loafers</a>
                                            </h5>
                                            <div className="flex-shrink-0 d-flex gap-4">
                                                <div className="d-flex flex-wrap align-items-center">
                                                    <button type="button" className="w-16 h-16 border border-2 border-white ms--6 bg-color-blue rounded-circle"></button>
                        ...
                        <div className="col-md-4 col-sm-6 col-xs-6">
                            <div className="scale-hover-item bg-white rounded-16 p-12 h-100 box-shadow-md">
                                <div className="course-item__thumb rounded-12 bg-main-25 overflow-hidden position-relative max-h-unset min-h-252">
                                    <a href="/product-details" className="w-100 h-100 d-flex justify-content-center align-items-center min-h-inherit">
                                        <img src="/assets/images/thumbs/product-img5.png" alt="Course Image" className="scale-hover-item__img rounded-12 transition-2" />
                                    </a>
                                    <div className="position-absolute inset-block-start-0 inset-inline-start-0 w-100 d-flex align-items-center justify-content-between p-16">
                                        <span className="py-8 px-16 bg-success-600 rounded-8 text-white">New</span>
                                        <button className="add-to-cart active-scale-08 w-40 h-40 rounded-8 d-flex justify-content-center align-items-center bg-white box-shadow-md text-neutral-500 text-lg hover-bg-main-100 hover-text-main-600 transition-2 ms-auto">
                                ...
                                <div className="pt-32 pb-24 px-16 position-relative">
                                    <div className="">
                                        <div className="d-flex align-items-center justify-content-between mb-16">
                                            <h5 className="mb-0">
                                                <a href="/product-details" className="link text-line-1">Oxfords leather</a>
                                            </h5>
                                            <div className="flex-shrink-0 d-flex gap-4">
                                                <div className="d-flex flex-wrap align-items-center">
                                                    <button type="button" className="w-16 h-16 border border-2 border-white ms--6 bg-color-blue rounded-circle"></button>
                        ...
                        <div className="col-md-4 col-sm-6 col-xs-6">
                            <div className="scale-hover-item bg-white rounded-16 p-12 h-100 box-shadow-md">
                                <div className="course-item__thumb rounded-12 bg-main-25 overflow-hidden position-relative max-h-unset min-h-252">
                                    <a href="/product-details" className="w-100 h-100 d-flex justify-content-center align-items-center min-h-inherit">
                                        <img src="/assets/images/thumbs/product-img6.png" alt="Course Image" className="scale-hover-item__img rounded-12 transition-2" />
                                    </a>
                                    <div className="position-absolute inset-block-start-0 inset-inline-start-0 w-100 d-flex align-items-center justify-content-between p-16">
                                        <button className="add-to-cart active-scale-08 w-40 h-40 rounded-8 d-flex justify-content-center align-items-center bg-white box-shadow-md text-neutral-500 text-lg hover-bg-main-100 hover-text-main-600 transition-2 ms-auto">
                                            <i className="ph ph-shopping-cart"></i>
                        ...
                        <div className="col-md-4 col-sm-6 col-xs-6">
                            <div className="scale-hover-item bg-white rounded-16 p-12 h-100 box-shadow-md">
                                <div className="course-item__thumb rounded-12 bg-main-25 overflow-hidden position-relative max-h-unset min-h-252">
                                    <a href="/product-details" className="w-100 h-100 d-flex justify-content-center align-items-center min-h-inherit">
                                        <img src="/assets/images/thumbs/product-img7.png" alt="Course Image" className="scale-hover-item__img rounded-12 transition-2" />
                                    </a>
                                    <div className="position-absolute inset-block-start-0 inset-inline-start-0 w-100 d-flex align-items-center justify-content-between p-16">
                                        <span className="py-8 px-16 bg-main-two-600 rounded-8 text-white">Sale</span>
                                        <button className="add-to-cart active-scale-08 w-40 h-40 rounded-8 d-flex justify-content-center align-items-center bg-white box-shadow-md text-neutral-500 text-lg hover-bg-main-100 hover-text-main-600 transition-2 ms-auto">
                                ...
                                <div className="pt-32 pb-24 px-16 position-relative">
                                    <div className="">
                                        <div className="d-flex align-items-center justify-content-between mb-16">
                                            <h5 className="mb-0">
                                                <a href="/product-details" className="link text-line-1">Heeled Flats</a>
                                            </h5>
                                            <div className="flex-shrink-0 d-flex gap-4">
                                                <div className="d-flex flex-wrap align-items-center">
                                                    <button type="button" className="w-16 h-16 border border-2 border-white ms--6 bg-color-blue rounded-circle"></button>
                        ...
                        <div className="col-md-4 col-sm-6 col-xs-6">
                            <div className="scale-hover-item bg-white rounded-16 p-12 h-100 box-shadow-md">
                                <div className="course-item__thumb rounded-12 bg-main-25 overflow-hidden position-relative max-h-unset min-h-252">
                                    <a href="/product-details" className="w-100 h-100 d-flex justify-content-center align-items-center min-h-inherit">
                                        <img src="/assets/images/thumbs/product-img8.png" alt="Course Image" className="scale-hover-item__img rounded-12 transition-2" />
                                    </a>
                                    <div className="position-absolute inset-block-start-0 inset-inline-start-0 w-100 d-flex align-items-center justify-content-between p-16">
                                        <button className="add-to-cart active-scale-08 w-40 h-40 rounded-8 d-flex justify-content-center align-items-center bg-white box-shadow-md text-neutral-500 text-lg hover-bg-main-100 hover-text-main-600 transition-2 ms-auto">
                                            <i className="ph ph-shopping-cart"></i>
                                ...
                                <div className="pt-32 pb-24 px-16 position-relative">
                                    <div className="">
                                        <div className="d-flex align-items-center justify-content-between mb-16">
                                            <h5 className="mb-0">
                                                <a href="/product-details" className="link text-line-1">Pumps classic</a>
                                            </h5>
                                            <div className="flex-shrink-0 d-flex gap-4">
                                                <div className="d-flex flex-wrap align-items-center">
                                                    <button type="button" className="w-16 h-16 border border-2 border-white ms--6 bg-color-blue rounded-circle"></button>
                        ...
                        <div className="col-md-4 col-sm-6 col-xs-6">
                            <div className="scale-hover-item bg-white rounded-16 p-12 h-100 box-shadow-md">
                                <div className="course-item__thumb rounded-12 bg-main-25 overflow-hidden position-relative max-h-unset min-h-252">
                                    <a href="/product-details" className="w-100 h-100 d-flex justify-content-center align-items-center min-h-inherit">
                                        <img src="/assets/images/thumbs/product-img9.png" alt="Course Image" className="scale-hover-item__img rounded-12 transition-2" />
                                    </a>
                                    <div className="position-absolute inset-block-start-0 inset-inline-start-0 w-100 d-flex align-items-center justify-content-between p-16">
                                        <button className="add-to-cart active-scale-08 w-40 h-40 rounded-8 d-flex justify-content-center align-items-center bg-white box-shadow-md text-neutral-500 text-lg hover-bg-main-100 hover-text-main-600 transition-2 ms-auto">
                                            <i className="ph ph-shopping-cart"></i>
                                ...
                                <div className="pt-32 pb-24 px-16 position-relative">
                                    <div className="">
                                        <div className="d-flex align-items-center justify-content-between mb-16">
                                            <h5 className="mb-0">
                                                <a href="/product-details" className="link text-line-1">Heels stilettos</a>
                                            </h5>
                                            <div className="flex-shrink-0 d-flex gap-4">
                                                <div className="d-flex flex-wrap align-items-center">
                                                    <button type="button" className="w-16 h-16 border border-2 border-white ms--6 bg-color-blue rounded-circle"></button>
                        ...
                        <div className="col-md-4 col-sm-6 col-xs-6">
                            <div className="scale-hover-item bg-white rounded-16 p-12 h-100 box-shadow-md">
                                <div className="course-item__thumb rounded-12 bg-main-25 overflow-hidden position-relative max-h-unset min-h-252">
                                    <a href="/product-details" className="w-100 h-100 d-flex justify-content-center align-items-center min-h-inherit">
                                        <img src="/assets/images/thumbs/product-img10.png" alt="Course Image" className="scale-hover-item__img rounded-12 transition-2" />
                                    </a>
                                    <div className="position-absolute inset-block-start-0 inset-inline-start-0 w-100 d-flex align-items-center justify-content-between p-16">
                                        <span className="py-8 px-16 bg-success-600 rounded-8 text-white">New</span>
                                        <button className="add-to-cart active-scale-08 w-40 h-40 rounded-8 d-flex justify-content-center align-items-center bg-white box-shadow-md text-neutral-500 text-lg hover-bg-main-100 hover-text-main-600 transition-2 ms-auto">
                                ...
                                <div className="pt-32 pb-24 px-16 position-relative">
                                    <div className="">
                                        <div className="d-flex align-items-center justify-content-between mb-16">
                                            <h5 className="mb-0">
                                                <a href="/product-details" className="link text-line-1">Sandals various</a>
                                            </h5>
                                            <div className="flex-shrink-0 d-flex gap-4">
                                                <div className="d-flex flex-wrap align-items-center">
                                                    <button type="button" className="w-16 h-16 border border-2 border-white ms--6 bg-color-blue rounded-circle"></button>
                        ...
                        <div className="col-md-4 col-sm-6 col-xs-6">
                            <div className="scale-hover-item bg-white rounded-16 p-12 h-100 box-shadow-md">
                                <div className="course-item__thumb rounded-12 bg-main-25 overflow-hidden position-relative max-h-unset min-h-252">
                                    <a href="/product-details" className="w-100 h-100 d-flex justify-content-center align-items-center min-h-inherit">
                                        <img src="/assets/images/thumbs/product-img11.png" alt="Course Image" className="scale-hover-item__img rounded-12 transition-2" />
                                    </a>
                                    <div className="position-absolute inset-block-start-0 inset-inline-start-0 w-100 d-flex align-items-center justify-content-between p-16">
                                        <button className="add-to-cart active-scale-08 w-40 h-40 rounded-8 d-flex justify-content-center align-items-center bg-white box-shadow-md text-neutral-500 text-lg hover-bg-main-100 hover-text-main-600 transition-2 ms-auto">
                                            <i className="ph ph-shopping-cart"></i>
                                ...
                                <div className="pt-32 pb-24 px-16 position-relative">
                                    <div className="">
                                        <div className="d-flex align-items-center justify-content-between mb-16">
                                            <h5 className="mb-0">
                                                <a href="/product-details" className="link text-line-1">Heels Wedges</a>
                                            </h5>
                                            <div className="flex-shrink-0 d-flex gap-4">
                                                <div className="d-flex flex-wrap align-items-center">
                                                    <button type="button" className="w-16 h-16 border border-2 border-white ms--6 bg-color-blue rounded-circle"></button>
                        ...
                        <div className="col-md-4 col-sm-6 col-xs-6">
                            <div className="scale-hover-item bg-white rounded-16 p-12 h-100 box-shadow-md">
                                <div className="course-item__thumb rounded-12 bg-main-25 overflow-hidden position-relative max-h-unset min-h-252">
                                    <a href="/product-details" className="w-100 h-100 d-flex justify-content-center align-items-center min-h-inherit">
                                        <img src="/assets/images/thumbs/product-img12.png" alt="Course Image" className="scale-hover-item__img rounded-12 transition-2" />
                                    </a>
                                    <div className="position-absolute inset-block-start-0 inset-inline-start-0 w-100 d-flex align-items-center justify-content-between p-16">
                                        <span className="py-8 px-16 bg-main-two-600 rounded-8 text-white">Sale</span>
                                        <button className="add-to-cart active-scale-08 w-40 h-40 rounded-8 d-flex justify-content-center align-items-center bg-white box-shadow-md text-neutral-500 text-lg hover-bg-main-100 hover-text-main-600 transition-2 ms-auto">
                                ...
                                <div className="pt-32 pb-24 px-16 position-relative">
                                    <div className="">
                                        <div className="d-flex align-items-center justify-content-between mb-16">
                                            <h5 className="mb-0">
                                                <a href="/product-details" className="link text-line-1">Mules flat sole</a>
                                            </h5>
                                            <div className="flex-shrink-0 d-flex gap-4">
                                                <div className="d-flex flex-wrap align-items-center">
                                                    <button type="button" className="w-16 h-16 border border-2 border-white ms--6 bg-color-blue rounded-circle"></button>
