...
<!-- ========Dashdord Sidebar end======== -->
                ...
                <div>
                    <div class="d-flex align-items-center gap-16 justify-content-between">
                        <h5 class="mb-16 text-white">Wishlist</h5>
                    ...
                    <div class="row gy-4">
                        ...
                        <div class="col-xl-4 col-md-6 wow fadeInUp" data-aos="fade-up" data-aos-duration="600">
                            <div class="course-item bg-white rounded-16 p-12 h-100 box-shadow-md">
                                ...
                                <div class="course-item__content">
                                        ...
                                        <div class="flex-between gap-8 flex-wrap">
                                            ...
                                            <div class="flex-align gap-8">
                                                <span class="text-neutral-700 text-2xl d-flex">
                                                    <img src="/assets/images/thumbs/dashbord-wishlist-img1.png" alt="User Image" class="w-32 h-32 object-fit-cover rounded-circle">
                                                </span>
                                    ...
                                    <div class="flex-between gap-8 pt-24 border-top border-neutral-50 mt-28 border-dashed border-0">
                                        <h4 class="mb-0 text-main-two-600">$159</h4>
                                        <a href="/apply-admission" class="flex-align gap-8 text-main-600 hover-text-decoration-underline transition-1 fw-semibold" tabindex="0">
                                            Enroll Now
                        ...
                        <div class="col-xl-4 col-md-6 wow fadeInUp" data-aos="fade-up" data-aos-duration="700">
                            <div class="course-item bg-white rounded-16 p-12 h-100 box-shadow-md">
                                <div class="course-item__thumb rounded-12 overflow-hidden position-relative">
                                    <a href="/course-details" class="w-100 h-100">
                                ...
                                <div class="course-item__content">
                                    <div class="">
                                        <h4 class="mb-28">
                                            <a href="/course-details" class="link text-line-2">Introduction to Python Programming</a>
                                        </h4>
                                        <div class="flex-between gap-8 flex-wrap mb-16">
                                            <div class="flex-align gap-8">
                                                <span class="text-neutral-700 text-2xl d-flex"><i class="ph-bold ph-video-camera"></i></span>
                        ...
                        <div class="col-xl-4 col-md-6 wow fadeInUp" data-aos="fade-up" data-aos-duration="800">
                            <div class="course-item bg-white rounded-16 p-12 h-100 box-shadow-md">
                                <div class="course-item__thumb rounded-12 overflow-hidden position-relative">
                                    <a href="/course-details" class="w-100 h-100">
                                ...
                                <div class="course-item__content">
                                    <div class="">
                                        <h4 class="mb-28">
                                            <a href="/course-details" class="link text-line-2">Introduction to Photography Masterclass</a>
                                        </h4>
                                        <div class="flex-between gap-8 flex-wrap mb-16">
                                            <div class="flex-align gap-8">
                                                <span class="text-neutral-700 text-2xl d-flex"><i class="ph-bold ph-video-camera"></i></span>
                        ...
                        <div class="col-xl-4 col-md-6 wow fadeInUp" data-aos="fade-up" data-aos-duration="900">
                            <div class="course-item bg-white rounded-16 p-12 h-100 box-shadow-md">
                                <div class="course-item__thumb rounded-12 overflow-hidden position-relative">
                                    <a href="/course-details" class="w-100 h-100">
                                ...
                                <div class="course-item__content">
                                    <div class="">
                                        <h4 class="mb-28">
                                            <a href="/course-details" class="link text-line-2">Spanish Language Mastery: Beginner to Fluent</a>
                                        </h4>
                                        <div class="flex-between gap-8 flex-wrap mb-16">
                                            <div class="flex-align gap-8">
                                                <span class="text-neutral-700 text-2xl d-flex"><i class="ph-bold ph-video-camera"></i></span>
                        ...
                        <div class="col-xl-4 col-md-6 wow fadeInUp" data-aos="fade-up" data-aos-duration="600">
                            <div class="course-item bg-white rounded-16 p-12 h-100 box-shadow-md">
                                ...
                                <div class="course-item__content">
                                    <div class="">
                                        <h4 class="mb-28">
                                            <a href="/course-details" class="link text-line-2">Financial Planning for Millennials</a>
                                        </h4>
                                        <div class="flex-between gap-8 flex-wrap mb-16">
                                            <div class="flex-align gap-8">
                                                <span class="text-neutral-700 text-2xl d-flex"><i class="ph-bold ph-video-camera"></i></span>
                        ...
                        <div class="col-xl-4 col-md-6 wow fadeInUp" data-aos="fade-up" data-aos-duration="700">
                            <div class="course-item bg-white rounded-16 p-12 h-100 box-shadow-md">
                                ...
                                <div class="course-item__content">
                                    <div class="">
                                        <h4 class="mb-28">
                                            <a href="/course-details" class="link text-line-2">Nutrition Essentials for Healthy Living</a>
                                        </h4>
                                        <div class="flex-between gap-8 flex-wrap mb-16">
                                            <div class="flex-align gap-8">
                                                <span class="text-neutral-700 text-2xl d-flex"><i class="ph-bold ph-video-camera"></i></span>
                ...
                <div class="d-flex align-items-center gap-12 text-center justify-content-center mt-32">
                    <button class="text-24 w-40 h-40 border-neutral-40 border rounded-circle hover-bg-main-600 transition-03 hover-text-white d-flex align-items-center justify-content-center">
