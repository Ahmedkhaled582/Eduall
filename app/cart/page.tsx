            ...
            <div class="col-lg-8">
                <div class="breadcrumb__wrapper">
                    ...
                    <ul class="breadcrumb__list d-flex align-items-center justify-content-center gap-4">
                        ...
                        <li class="breadcrumb__item"> 
                            <span class="text-main-two-600"> Cart List </span> 
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="border border-neutral-30 rounded-12 bg-main-25 p-32 bg-main-25">
                        <h4 class="mb-0">Cart <span class="text-neutral-100 fw-normal">(4 item)</span> </h4>
                        ...
                        <div class="table-responsive overflow-x-auto">
                            <table class="table min-w-max vertical-middle mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        <td class="border-bottom border-dashed border-neutral-40 text-neutral-500 bg-transparent px-24 py-20">
                                            <div class="d-flex align-items-center gap-24">
                                                ...
                                                <div class="">
                                                    <h6 class="text-md mb-12 text-line-1">Chuck 70 Hi Sneaker</h6>
                                                    <div class="d-flex align-items-center gap-16">
                                                        <div class="d-flex align-items-center gap-4">
                                                            <span class="text-xs text-neutral-500">Size:</span>
                                                            <span class="w-20 h-20 border border-neutral-40 bg-white rounded-4 d-flex justify-content-center align-items-center text-sm text-neutral-500">9</span>
                                                        </div>
                                                        <span class="h-20 border border-neutral-40 border-dashed"></span>
                                                        <div class="d-flex align-items-center gap-4">
                                                            <span class="text-xs text-neutral-500">Color:</span>
                                                            <span class="w-20 h-20 border border-neutral-40 bg-white rounded-4 d-flex justify-content-center align-items-center text-sm text-neutral-500">
                                                                <span class="w-12 h-12 rounded-circle bg-pen"></span>
                                                            </span>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <td class="border-bottom border-dashed border-neutral-40 text-neutral-500 bg-transparent px-24 py-20">
                                            <div class="border border-neutral-40 bg-main-50 rounded-pill p-4 max-w-116 w-100 d-flex justify-content-between">
                                                <button type="button" class="quantity__minus item-active-effect transition-1 flex-shrink-0 text-md hover-text-white w-36 h-36 rounded-circle bg-white text-neutral-500 hover-bg-main-600 border border-neutral-40 hover-border-main-600 hover-text-white flex-center">
                                                ...
                                                <button type="button" class="quantity__plus item-active-effect transition-1 flex-shrink-0 text-md hover-text-white w-36 h-36 rounded-circle bg-white text-neutral-500 hover-bg-main-600 border border-neutral430 hover-border-main-600 hover-text-white flex-center">
                                                    <i class="ph-bold ph-plus"></i>
                                                </button>
                                            </div>
                                            <span class="text-neutral-100 mt-8 text-xs">Available: 72</span>
                                        </td>
                                        <td class="border-bottom border-dashed border-neutral-40 text-neutral-500 bg-transparent px-24 py-20">
                                            $66.70
                                        </td>
                                        <td class="border-bottom border-dashed border-neutral-40 text-neutral-500 bg-transparent px-24 py-20">
                                            <button class="delete-btn text-lg hover-text-main-600 transition-2">
                                    ...
                                    <tr>
                                        <td class="border-bottom border-dashed border-neutral-40 text-neutral-500 bg-transparent px-24 py-20">
                                            <div class="d-flex align-items-center gap-24">
                                                ...
                                                <div class="">
                                                    <h6 class="text-md mb-12 text-line-1">Cotu Classic Sneaker</h6>
                                                    <div class="d-flex align-items-center gap-16">
                                                        <div class="d-flex align-items-center gap-4">
                                                            <span class="text-xs text-neutral-500">Size:</span>
                                                            <span class="w-20 h-20 border border-neutral-40 bg-white rounded-4 d-flex justify-content-center align-items-center text-sm text-neutral-500">9</span>
                                                        ...
                                                        <div class="d-flex align-items-center gap-4">
                                                            <span class="text-xs text-neutral-500">Color:</span>
                                                            <span class="w-20 h-20 border border-neutral-40 bg-white rounded-4 d-flex justify-content-center align-items-center text-sm text-neutral-500">
                                                                <span class="w-12 h-12 rounded-circle bg-watch"></span>
                                                            </span>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <tr>
                                        <td class="border-bottom border-dashed border-neutral-40 text-neutral-500 bg-transparent px-24 py-20">
                                            <div class="d-flex align-items-center gap-24">
                                                ...
                                                <div class="">
                                                    <h6 class="text-md mb-12 text-line-1">Zoom Freak 2</h6>
                                                    <div class="d-flex align-items-center gap-16">
                                                        <div class="d-flex align-items-center gap-4">
                                                            <span class="text-xs text-neutral-500">Size:</span>
                                                            <span class="w-20 h-20 border border-neutral-40 bg-white rounded-4 d-flex justify-content-center align-items-center text-sm text-neutral-500">9</span>
                                                        ...
                                                        <div class="d-flex align-items-center gap-4">
                                                            <span class="text-xs text-neutral-500">Color:</span>
                                                            <span class="w-20 h-20 border border-neutral-40 bg-white rounded-4 d-flex justify-content-center align-items-center text-sm text-neutral-500">
                                                                <span class="w-12 h-12 rounded-circle bg-black"></span>
                                                            </span>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <tr>
                                        <td class="border-bottom border-dashed border-neutral-40 text-neutral-500 bg-transparent px-24 py-20">
                                            <div class="d-flex align-items-center gap-24">
                                                ...
                                                <div class="">
                                                    <h6 class="text-md mb-12 text-line-1">Classic Sneaker</h6>
                                                    <div class="d-flex align-items-center gap-16">
                                                        <div class="d-flex align-items-center gap-4">
                                                            <span class="text-xs text-neutral-500">Size:</span>
                                                            <span class="w-20 h-20 border border-neutral-40 bg-white rounded-4 d-flex justify-content-center align-items-center text-sm text-neutral-500">9</span>
                                                        ...
                                                        <div class="d-flex align-items-center gap-4">
                                                            <span class="text-xs text-neutral-500">Color:</span>
                                                            <span class="w-20 h-20 border border-neutral-40 bg-white rounded-4 d-flex justify-content-center align-items-center text-sm text-neutral-500">
                                                                <span class="w-12 h-12 rounded-circle bg-table"></span>
                                                            </span>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <a href="/apply-admission" class="flex-align gap-8 text-main-600 hover-text-decoration-underline transition-1 fw-semibold mt-24" tabindex="0">
                ...
                <div class="col-lg-4">
                    <div class="border border-neutral-30 rounded-12 bg-main-25 p-24 bg-main-25">
                        ...
                        <form action="#" class="my-24 position-relative">
                        ...
                        <a href="/checkout" class="btn btn-main rounded-pill w-100 mt-40">
                            Check Out
                        </a>
                    </div>
                </div>
