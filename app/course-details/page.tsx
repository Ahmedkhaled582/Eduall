                ...
                <div class="col-xl-8">
                    ...
                    <div class="border border-neutral-30 rounded-12 bg-main-25 p-32 mt-24">
                        <div class="d-flex align-items-start flex-wrap flex-md-nowrap gap-32">
                            <img src="/assets/images/thumbs/details-instructor.png" alt="" class="">
                            <div class="">
                        ...
                        <div class="border border-neutral-30 rounded-12 bg-main-25 p-24 bg-main-25">
                            ...
                            <div class="border-bottom border-neutral-40 pb-24 mb-24 flex-between flex-wrap gap-16">
                                <div class="flex-align gap-12">
                                    ...
                                    <span class="text-neutral-700 text-lg fw-normal">Courses Title</span>
                                </div>
                                <span class="text-lg fw-medium text-neutral-700">Web Development</span>
                            </div>
                            <div class="border-bottom border-neutral-40 pb-24 mb-24 flex-between flex-wrap gap-16">
                                <div class="flex-align gap-12">
                                ...
                                <span class="text-lg fw-medium text-neutral-700">16 Videos</span>
                            </div>
                            <div class="border-bottom border-neutral-40 pb-24 mb-24 flex-between flex-wrap gap-16">
                                <div class="flex-align gap-12">
                                ...
                                <span class="text-lg fw-medium text-neutral-700">English</span>
                            </div>
                            <div class="border-bottom border-neutral-40 pb-24 mb-24 flex-between flex-wrap gap-16">
                                <div class="flex-align gap-12">
                                ...
                                <span class="text-lg fw-medium text-neutral-700">Beginner</span>
                            </div>
                            <div class="border-bottom border-neutral-40 pb-24 mb-24 flex-between flex-wrap gap-16">
                                <div class="flex-align gap-12">
                                ...
                                <span class="text-lg fw-medium text-neutral-700">4.7(5.5k)</span>
                            </div>
                            <div class="border-bottom border-neutral-40 pb-24 mb-24 flex-between flex-wrap gap-16">
                                <div class="flex-align gap-12">
                                    <span class="text-neutral-700 text-2xl d-flex"> <i class="ph ph-question"></i> </span>
                                    <span class="text-neutral-700 text-lg fw-normal">Quizzes</span>
                                </div>
                                <span class="text-lg fw-medium text-neutral-700">08</span>
                            </div>
                            <div class="border-bottom border-neutral-40 pb-24 mb-24 flex-between flex-wrap gap-16">
                                <div class="flex-align gap-12">
                                ...
                                <span class="text-lg fw-medium text-neutral-700">7 Weeks</span>
                            </div>
                            <div class="border-bottom border-neutral-40 pb-24 mb-24 flex-between flex-wrap gap-16">
                                <div class="flex-align gap-12">
                            ...
                            <div class="border-bottom border-neutral-40 pb-24 mb-24 flex-between flex-wrap gap-16">
                                <div class="flex-align gap-12">
                                    ...
                                    <span class="text-neutral-700 text-lg fw-normal">Certifications</span>
                                </div>
                                <span class="text-lg fw-medium text-neutral-700">Yes</span>
                            </div>
                            <div class="border-bottom border-neutral-40 pb-24 mb-24 flex-between flex-wrap gap-16">
                                <div class="flex-align gap-12">
                                    <span class="text-neutral-700 text-2xl d-flex"> <i class="ph ph-seal-percent"></i> </span>
                                    <span class="text-neutral-700 text-lg fw-normal">Pass Percentage</span>
                                </div>
                                <span class="text-lg fw-medium text-neutral-700">88%</span>
                            </div>
                            <div class="border-bottom border-neutral-40 pb-24 mb-24 flex-between flex-wrap gap-16">
                                <div class="flex-align gap-12">
                                    <span class="text-neutral-700 text-2xl d-flex"> <i class="ph ph-calendar-dot"></i> </span>
                                    <span class="text-neutral-700 text-lg fw-normal">Deadline</span>
                                </div>
                                <span class="text-lg fw-medium text-neutral-700">01 Jun, 2024</span>
                            </div>
                            <div class="border-bottom border-neutral-40 pb-24 mb-24 flex-between flex-wrap gap-16">
                                <div class="flex-align gap-12">
                                    <span class="text-neutral-700 text-2xl d-flex"> <i class="ph ph-user-circle"></i> </span>
                                    <span class="text-neutral-700 text-lg fw-normal">Instructor </span>
                                </div>
                                <span class="text-lg fw-medium text-neutral-700">Denial Lie</span>
                            </div>
                            <a href="/contact" class="btn btn-main rounded-pill flex-center gap-8 mt-40">
                                See All Reviews
                                <i class="ph-bold ph-arrow-up-right d-flex text-lg"></i>
                            </a>
