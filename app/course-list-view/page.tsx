        ...
        <div className="row justify-content-center">
            <div className="col-lg-8">
                <div className="breadcrumb__wrapper">
                    <h1 className="breadcrumb__title display-4 fw-semibold text-center"> Courses List View</h1>
                    ...
                    <div className="sidebar rounded-12 bg-main-25 p-32 border border-neutral-30">
                        <form action="#">
                            ...
                            <div className="position-relative">
                                <input type="text" className="common-input pe-48 rounded-pill" placeholder="Enter Your Email..." />
                                <button type="submit" className="text-neutral-500 text-xl d-flex position-absolute top-50 translate-middle-y inset-inline-end-0 me-24 hover-text-main-600"><i className="ph-bold ph-magnifying-glass"></i></button>
                            </div>
                            ...
                            <div className="d-flex flex-column gap-16">
                                <div className="flex-between gap-16">
                                    <div className="form-check common-check mb-0">
                                        <input className="form-check-input" type="checkbox" name="categories" id="3254" />
                                        <label className="form-check-label fw-normal flex-grow-1" htmlFor="3254">Health and Wellness Courses</label>
                                    </div>
                                    <span className="text-neutral-500">3254</span>
                                </div>
                                <div className="flex-between gap-16">
                                    <div className="form-check common-check mb-0">
                                        <input className="form-check-input" type="checkbox" name="categories" id="1522" />
                                        <label className="form-check-label fw-normal flex-grow-1" htmlFor="1522">Language Courses</label>
                                    </div>
                                    <span className="text-neutral-500">1522</span>
                                </div>
                                <div className="flex-between gap-16">
                                    <div className="form-check common-check mb-0">
                                        <input className="form-check-input" type="checkbox" name="categories" id="2545" />
                                        <label className="form-check-label fw-normal flex-grow-1" htmlFor="2545">Computer and Technology</label>
                                    </div>
                                    <span className="text-neutral-500">2545</span>
                                </div>
                                <div className="flex-between gap-16">
                                    <div className="form-check common-check mb-0">
                                        <input className="form-check-input" type="checkbox" name="categories" id="3215" />
                                        <label className="form-check-label fw-normal flex-grow-1" htmlFor="3215">HealthWellnessCourses</label>
                                    </div>
                                    <span className="text-neutral-500">3215</span>
                                </div>
                                <div className="flex-between gap-16">
                                    <div className="form-check common-check mb-0">
                                        <input className="form-check-input" type="checkbox" name="categories" id="5526" />
                                        <label className="form-check-label fw-normal flex-grow-1" htmlFor="5526">Business and Finance Courses</label>
                                    </div>
                                    <span className="text-neutral-500">5526</span>
                                </div>
                                <div className="flex-between gap-16">
                                    <div className="form-check common-check mb-0">
                                        <input className="form-check-input" type="checkbox" name="categories" id="1563" />
                                        <label className="form-check-label fw-normal flex-grow-1" htmlFor="1563">Academic Courses</label>
                                    </div>
                                    <span className="text-neutral-500">1563</span>
                                </div>
                                <div className="flex-between gap-16">
                                    <div className="form-check common-check mb-0">
                                        <input className="form-check-input" type="checkbox" name="categories" id="4154" />
                                        <label className="form-check-label fw-normal flex-grow-1" htmlFor="4154">Art and Creative Courses</label>
                                    </div>
                                    <span className="text-neutral-500">4154</span>
                                </div>
                                <div className="flex-between gap-16">
                                    <div className="form-check common-check mb-0">
                                        <input className="form-check-input" type="checkbox" name="categories" id="categories1" />
                                        <label className="form-check-label fw-normal flex-grow-1" htmlFor="categories1">HealthWellnessCourses</label>
                                    </div>
                                    <span className="text-neutral-500">3215</span>
                                </div>
                                <div className="flex-between gap-16">
                                    <div className="form-check common-check mb-0">
                                        <input className="form-check-input" type="checkbox" name="categories" id="4146" />
                                        <label className="form-check-label fw-normal flex-grow-1" htmlFor="4146">Professional Development</label>
                                    </div>
                                    <span className="text-neutral-500">4146</span>
                                </div>
                                <div className="flex-between gap-16">
                                    <div className="form-check common-check mb-0">
                                        <input className="form-check-input" type="checkbox" name="categories" id="4955" />
                                        <label className="form-check-label fw-normal flex-grow-1" htmlFor="4955">Science and Engineering</label>
                                    </div>
                                    <span className="text-neutral-500">4955</span>
                                </div>
                            </div>
                            <a href="/course" className="text-sm text-main-600 fw-semibold mt-24 hover-text-decoration-underline">See All </a>
                            <span className="d-block border border-neutral-30 border-dashed my-24"></span>
                            ...
                            <div className="flex-align flex-wrap gap-12">
                                <a href="/course" className="border border-neutral-30 px-20 py-12 rounded-pill bg-white text-neutral-500 hover-border-main-600 hover-text-main-600">UI/UX Design</a>
                                <a href="/course" className="border border-neutral-30 px-20 py-12 rounded-pill bg-white text-neutral-500 hover-border-main-600 hover-text-main-600">Web Development</a>
                                <a href="/course" className="border border-neutral-30 px-20 py-12 rounded-pill bg-white text-neutral-500 hover-border-main-600 hover-text-main-600">Wordpress</a>
                                <a href="/course" className="border border-neutral-30 px-20 py-12 rounded-pill bg-white text-neutral-500 hover-border-main-600 hover-text-main-600">Machine Learning</a>
                                <a href="/course" className="border border-neutral-30 px-20 py-12 rounded-pill bg-white text-neutral-500 hover-border-main-600 hover-text-main-600">AI</a>
                                <a href="/course" className="border border-neutral-30 px-20 py-12 rounded-pill bg-white text-neutral-500 hover-border-main-600 hover-text-main-600">Laravel</a>
                                <a href="/course" className="border border-neutral-30 px-20 py-12 rounded-pill bg-white text-neutral-500 hover-border-main-600 hover-text-main-600">Python</a>
                            </div>
                            <a href="/course" className="text-sm text-main-600 fw-semibold mt-24 hover-text-decoration-underline">More Tags </a>
                            <span className="d-block border border-neutral-30 border-dashed my-24"></span>
    
                            <h6 className="text-lg mb-24 fw-medium">Level</h6>
                            <div className="d-flex flex-column gap-16">
                                <div className="form-check common-check mb-0">
                                    <input className="form-check-input" type="checkbox" name="categories" id="AllLevels" />
                                    <label className="form-check-label fw-normal flex-grow-1" htmlFor="AllLevels">All Levels</label>
                                </div>
                                <div className="form-check common-check mb-0">
                                    <input className="form-check-input" type="checkbox" name="categories" id="Beginner" />
                                    <label className="form-check-label fw-normal flex-grow-1" htmlFor="Beginner">Beginner</label>
                                </div>
                                <div className="form-check common-check mb-0">
                                    <input className="form-check-input" type="checkbox" name="categories" id="Intermediate" />
                                    <label className="form-check-label fw-normal flex-grow-1" htmlFor="Intermediate">Intermediate</label>
                                </div>
                                <div className="form-check common-check mb-0">
                                    <input className="form-check-input" type="checkbox" name="categories" id="Expert" />
                                    <label className="form-check-label fw-normal flex-grow-1" htmlFor="Expert">Expert</label>
                                </div>
                            </div>
                            <span className="d-block border border-neutral-30 border-dashed my-24"></span>
                        ...
                        <div className="row gy-4">
                            ...
                            <div className="col-12">
                                <div className="course-item bg-main-25 rounded-16 p-12 h-100 border border-neutral-30 list-view">
                                    <div className="course-item__thumb rounded-12 overflow-hidden position-relative">
                                        <a href="/course-details" className="w-100 h-100">
                                            <img src="/assets/images/thumbs/course-img7.png" alt="Course Image" className="course-item__img rounded-12 cover-img transition-2" />
                                        </a>
                                        <div className="flex-align gap-8 bg-main-600 rounded-pill px-24 py-12 text-white position-absolute inset-block-start-0 inset-inline-start-0 mt-20 ms-20 z-1">
                                            <span className="text-2xl d-flex"><i className="ph ph-clock"></i></span>
                                            <span className="text-lg fw-medium">9h 36m</span>
                            ...
                            <div className="col-12">
                                <div className="course-item bg-main-25 rounded-16 p-12 h-100 border border-neutral-30 list-view">
                                    <div className="course-item__thumb rounded-12 overflow-hidden position-relative">
                                        <a href="/course-details" className="w-100 h-100">
                                            <img src="/assets/images/thumbs/course-img9.png" alt="Course Image" className="course-item__img rounded-12 cover-img transition-2" />
                                        </a>
                                        <div className="flex-align gap-8 bg-main-600 rounded-pill px-24 py-12 text-white position-absolute inset-block-start-0 inset-inline-start-0 mt-20 ms-20 z-1">
                                            <span className="text-2xl d-flex"><i className="ph ph-clock"></i></span>
                                            <span className="text-lg fw-medium">9h 36m</span>
                            ...
                            <div className="col-12">
                                <div className="course-item bg-main-25 rounded-16 p-12 h-100 border border-neutral-30 list-view">
                                    <div className="course-item__thumb rounded-12 overflow-hidden position-relative">
                                        <a href="/course-details" className="w-100 h-100">
                                            <img src="/assets/images/thumbs/course-img8.png" alt="Course Image" className="course-item__img rounded-12 cover-img transition-2" />
                                        </a>
                                        <div className="flex-align gap-8 bg-main-600 rounded-pill px-24 py-12 text-white position-absolute inset-block-start-0 inset-inline-start-0 mt-20 ms-20 z-1">
                                            <span className="text-2xl d-flex"><i className="ph ph-clock"></i></span>
                                            <span className="text-lg fw-medium">9h 36m</span>
