            ...
            <div class="col-lg-8">
                <div class="breadcrumb__wrapper">
                    ...
                    <ul class="breadcrumb__list d-flex align-items-center justify-content-center gap-4">
                        ...
                        <li class="breadcrumb__item">
                            <a href="/course" class="breadcrumb__link text-neutral-500 hover-text-main-600 fw-medium"> Courses</a> 
                        </li>
                        <li class="breadcrumb__item ">
                            <i class="text-neutral-500 d-flex ph-bold ph-caret-right"></i>
                        </li>
                    ...
                    <div class="sidebar rounded-12 bg-main-25 p-32 border border-neutral-30">
                        <form action="#">
                            ...
                            <div class="position-relative">
                                <input type="text" class="common-input pe-48 rounded-pill" placeholder="Enter Your Email...">
                            ...
                            <a href="/course" class="text-sm text-main-600 fw-semibold mt-24 hover-text-decoration-underline">See All </a>
                            <span class="d-block border border-neutral-30 border-dashed my-24"></span>
                            ...
                            <div class="flex-align flex-wrap gap-12">
                                <a href="/course" class="border border-neutral-30 px-20 py-12 rounded-pill bg-white text-neutral-500 hover-border-main-600 hover-text-main-600">UI/UX Design</a>
                                <a href="/course" class="border border-neutral-30 px-20 py-12 rounded-pill bg-white text-neutral-500 hover-border-main-600 hover-text-main-600">Web Development</a>
                                <a href="/course" class="border border-neutral-30 px-20 py-12 rounded-pill bg-white text-neutral-500 hover-border-main-600 hover-text-main-600">Wordpress</a>
                                <a href="/course" class="border border-neutral-30 px-20 py-12 rounded-pill bg-white text-neutral-500 hover-border-main-600 hover-text-main-600">Machine Learning</a>
                                <a href="/course" class="border border-neutral-30 px-20 py-12 rounded-pill bg-white text-neutral-500 hover-border-main-600 hover-text-main-600">AI</a>
                                <a href="/course" class="border border-neutral-30 px-20 py-12 rounded-pill bg-white text-neutral-500 hover-border-main-600 hover-text-main-600">Laravel</a>
                                <a href="/course" class="border border-neutral-30 px-20 py-12 rounded-pill bg-white text-neutral-500 hover-border-main-600 hover-text-main-600">Python</a>
                            </div>
                            <a href="/course" class="text-sm text-main-600 fw-semibold mt-24 hover-text-decoration-underline">More Tags </a>
                            <span class="d-block border border-neutral-30 border-dashed my-24"></span>
