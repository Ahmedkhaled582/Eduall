                ...
                <div class="row">
                    <div class="col-xxl-6 col-xl-8 col-lg-10 z-1">
                        ...
                        <div class="buttons-wrapper flex-align flex-wrap gap-24 mt-40">
                            <a href="/sign-in" class="btn btn-main rounded-pill flex-align gap-8  wow bounceInLeft" data-wow-duration="1s" data-wow-delay=".5s">
                                Apply Now
                            ...
                            <div class="flex-align gap-16  wow bounceInRight" data-wow-duration="1s" data-wow-delay=".5s">
                                ...
                                <a href="/course" class="text-white hover-text-decoration-underline hover-text-main-two-600">See All University</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-6">
                    <div class="about-three-content">
                        ...
                        <div class="pt-40 border-top border-neutral-50 mt-40 border-dashed border-0">
                            <a href="/about" class="btn btn-main rounded-pill flex-align d-inline-flex gap-8">
                                Read More
                                <i class="ph-bold ph-arrow-up-right d-flex text-lg"></i>
                            </a>
                        </div>
...
<section class="faculty pb-120 bg-main-25">
    <div class="container">
                    ...
                    <div class="pt-32 pb-24 px-16 position-relative">
                        <div class="">
                            ...
                            <div class="flex-between gap-8 flex-wrap mb-16">
                                <a href="/course" class="py-8 px-20 rounded-8 flex-align gap-8 text-main-600 fw-medium bg-main-25 hover-bg-main-600 hover-text-white">
                            ...
                            <h4 class="mb-28">
                                <a href="/course-details" class="link text-line-2">Faculty of Engineering Admissions</a>
                            </h4>
                            <ul class="check-list">
                ...
                <div class="scale-hover-item bg-white rounded-16 p-12 h-100 box-shadow-md">
                    ...
                    <div class="pt-32 pb-24 px-16 position-relative">
                        <div class="">
                            ...
                            <h4 class="mb-28">
                                <a href="/course-details" class="link text-line-2">Arts and Humanities Admissions</a>
                            </h4>
                            <ul class="check-list">
                                <li class="flex-align gap-8">
                                    <img src="/assets/images/icons/check.png" alt="">
                ...
                <div class="scale-hover-item bg-white rounded-16 p-12 h-100 box-shadow-md">
                    ...
                    <div class="pt-32 pb-24 px-16 position-relative">
                        <div class="">
                            ...
                            <h4 class="mb-28">
                                <a href="/course-details" class="link text-line-2">Social And Sciences Admissions</a>
                            </h4>
                            <ul class="check-list">
                                <li class="flex-align gap-8">
                                    <img src="/assets/images/icons/check.png" alt="">
                ...
                <div class="scale-hover-item bg-white rounded-16 p-12 h-100 box-shadow-md">
                    ...
                    <div class="pt-32 pb-24 px-16 position-relative">
                        <div class="">
                            ...
                            <h4 class="mb-28">
                                <a href="/course-details" class="link text-line-2">Computer Science Admissions</a>
                            </h4>
                            <ul class="check-list">
                                <li class="flex-align gap-8">
                                    <img src="/assets/images/icons/check.png" alt="">
                ...
                <div class="scale-hover-item bg-white rounded-16 p-12 h-100 box-shadow-md">
                    ...
                    <div class="pt-32 pb-24 px-16 position-relative">
                        <div class="">
                            ...
                            <h4 class="mb-28">
                                <a href="/course-details" class="link text-line-2">Business and Economics Admissions</a>
                            </h4>
                            <ul class="check-list">
                                <li class="flex-align gap-8">
                                    <img src="/assets/images/icons/check.png" alt="">
                ...
                <div class="scale-hover-item bg-white rounded-16 p-12 h-100 box-shadow-md">
                    ...
                    <div class="pt-32 pb-24 px-16 position-relative">
                        <div class="">
                            ...
                            <h4 class="mb-28">
                                <a href="/course-details" class="link text-line-2">Medicine and Health Sciences Admissions</a>
                            </h4>
                            <ul class="check-list">
                                <li class="flex-align gap-8">
                                    <img src="/assets/images/icons/check.png" alt="">
        ...
        <div class="text-center mt-40">
            <a href="/about" class="btn btn-outline-main rounded-pill flex-align d-inline-flex gap-8">
                See All University
                <i class="ph-bold ph-arrow-up-right d-flex text-lg"></i>
            </a>
        </div>
        ...
        <div class="row align-items-end">
            <div class="col-lg-7 pe-xl-5">
                <div class="pb-80 mb-lg-5 me-lg-5">
                    ...
                    <a href="/about" class="btn btn-main rounded-pill flex-align d-inline-flex gap-8 mt-40">
                        Read More
                        <i class="ph-bold ph-arrow-up-right d-flex text-lg"></i>
                    </a>
                </div>
            ...
            <div class="col-lg-5">
                <div class="pt-40 pb-90 px-60 bg-neutral-900 rounded-top-4" data-aos="fade-up-left">
                    ...
                    <ul>
                        <li class="mb-24">
                            <a href="/contact" class="flex-align gap-12 text-white hover-text-decoration-underline">
                                Admission Notice
