...
<!-- ==================== Breadcrumb End Here ==================== -->
    ...
    <!-- ================================ About Four Start =============================== -->
<section class="about-four py-120 position-relative z-1 overflow-hidden">
            ...
            <div class="row gy-xl-0 gy-5 flex-wrap-reverse align-items-center">
                <div class="col-xl-6 pe-xl-5">
                    <div class="about-two__thumb position-relative pe-0 me-xl-5">
                        ...
                        <div class="offer-message animation-item style-two px-24 py-12 inset-inline-end--64 rounded-6 border border-white bg-success-600 fw-medium flex-align d-inline-flex gap-16 box-shadow-lg">
                    ...
                    <div class="about-two-content">
                        ...
                        <div class="grid-cols-2">
                            ...
                            <div class="flex-align align-items-start gap-20 animation-item" data-aos="fade-up" data-aos-duration="800">
                                <span class="flex-shrink-0 w-56 h-56 flex-center d-inline-flex bg-success-100 text-success-600 text-32 rounded-circle box-shadow-md">
                            ...
                            <div class="flex-align align-items-start gap-20 animation-item" data-aos="fade-up" data-aos-duration="1000">
                                <span class="flex-shrink-0 w-56 h-56 flex-center d-inline-flex bg-warning-100 text-warning-600 text-32 rounded-circle box-shadow-md">
                            ...
                            <div class="flex-align align-items-start gap-20 animation-item" data-aos="fade-up" data-aos-duration="1200">
                                <span class="flex-shrink-0 w-56 h-56 flex-center d-inline-flex bg-info-100 text-info-600 text-32 rounded-circle box-shadow-md">
