...
import ApplyAdmissionSection from '@/components/admission/ApplyAdmissionSection';
...
export default function Page() {
  return (
    <>
      ...
      <Breadcrumb title="Apply for Admission" pageName="Apply for Admission" />
      <ApplyAdmissionSection />
      <CertificateSection />
