                ...
                <div>   
                    <div class="mb-32">
                        <div class="d-flex align-items-center gap-16 justify-content-between">
                            <h5 class="mb-16 text-white">Dashboard</h5>
                            <button type="button" class="toggle-student-dashbord-button text-white text-32 d-xl-none d-block">
                        ...
                        <div class="row gy-4">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="bg-white px-20 py-20 rounded-10">
                                    <div class="d-flex align-items-center gap-16 justify-content-between flex-wrap mb-16">
                                        <div>
                                            <span class="text-14 fw-normal text-neutral-400 mb-4">All Courses</span>
                                            <h6 class="text-18 fw-semibold mb-0">35</h6>
                                        </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="bg-white px-20 py-20 rounded-10">
                                    <div class="d-flex align-items-center gap-16 justify-content-between flex-wrap mb-16">
                                        <div>
                                            <span class="text-14 fw-normal text-neutral-400 mb-4">Enrolled Courses</span>
                                            <h6 class="text-18 fw-semibold mb-0">15</h6>
                                        </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="bg-white px-20 py-20 rounded-10">
                                    <div class="d-flex align-items-center gap-16 justify-content-between flex-wrap mb-16">
                                        <div>
                                            <span class="text-14 fw-normal text-neutral-400 mb-4">Active Courses</span>
                                            <h6 class="text-18 fw-semibold mb-0">11</h6>
                                        </div>
                                        <div class="w-44 h-44 bg-warning-700 rounded-circle text-white text-20 d-flex align-items-center justify-content-center">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="bg-white px-20 py-20 rounded-10">
                                    <div class="d-flex align-items-center gap-10 justify-content-between flex-wrap mb-16">
                                        <div>
                                            <span class="text-14 fw-normal text-neutral-400 mb-4">Completed Courses</span>
                                            <h6 class="text-18 fw-semibold mb-0">4</h6>
                                        </div>
                                        <div class="w-44 h-44 bg-warning-700 rounded-circle text-white text-20 d-flex align-items-center justify-content-center">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="bg-white px-20 py-20 rounded-10">
                                    <div class="d-flex align-items-center gap-10 justify-content-between flex-wrap mb-16">
                                        <div>
                                            <span class="text-14 fw-normal text-neutral-400 mb-4">Total Students</span>
                                            <h6 class="text-18 fw-semibold mb-0">4</h6>
                                        </div>
                                        <div class="w-44 h-44 bg-main-600 rounded-circle text-white text-20 d-flex align-items-center justify-content-center">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="bg-white px-20 py-20 rounded-10">
                                    <div class="d-flex align-items-center gap-16 justify-content-between flex-wrap mb-16">
                                        <div>
                                            <span class="text-14 fw-normal text-neutral-400 mb-4">Total Earnings</span>
                                            <h6 class="text-18 fw-semibold mb-0">$56,542.00</h6>
                                        </div>
                                        <div class="w-44 h-44 bg-success-600 rounded-circle text-white text-20 d-flex align-items-center justify-content-center">
...
<h5 class="mb-16 text-neutral-500">In progress Courses</h5>
<div class="row gy-4">
            ...
            <div class="course-item__content">
                ...
                <div class="flex-between gap-8 mt-28 flex-wrap">
                    ...
                    <div class="d-flex align-items-center gap-8">
                        <img src="/assets/images/thumbs/instructor-dashboard-img2.png" alt="" class="w-28 h-28">
    ...
    <div class="col-xl-4 col-md-6 col-sm-6 wow fadeInUp" data-aos="fade-up" data-aos-duration="1200">
        <div class="course-item bg-white rounded-16 p-12 h-100 box-shadow-md">
            <div class="course-item__thumb rounded-12 overflow-hidden">
                <a href="/course-details" class="w-100 h-100">
    ...
    <div class="col-xl-4 col-md-6 col-sm-6 wow fadeInUp" data-aos="fade-up" data-aos-duration="1400">
        <div class="course-item bg-white rounded-16 p-12 h-100 box-shadow-md">
            <div class="course-item__thumb rounded-12 overflow-hidden">
                <a href="/course-details" class="w-100 h-100">
    ...
    <div class="col-xl-4 col-md-6 col-sm-6 wow fadeInUp" data-aos="fade-up" data-aos-duration="1600">
        <div class="course-item bg-white rounded-16 p-12 h-100 box-shadow-md">
            <div class="course-item__thumb rounded-12 overflow-hidden">
                <a href="/course-details" class="w-100 h-100">
...
<!-- progress Courses end  -->
                    ...
                    <!-- ============Feedbacks start============ -->
                    <div class="w-100 mt-32 overflow-x-auto">
                
                        <div class="px-24 py-24 bg-white rounded-10">
                                <h6 class="mb-0 fw-medium">Total Feedbacks</h6>
                            <div class="mb-24">
                                    ...
                                    <table id="example-five" class="display min-w-max w-100 ">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="hover-bg-neutral-20 transition-03">
                                                ...
                                                <td class="py-28 px-20 shadow-none">8</td>
                                            </tr>
                                            ...
                                            <tr class="hover-bg-neutral-20 transition-03">
                                                ...
                                                <td class="py-28 px-20 shadow-none">13</td>
                                            </tr>
                                            ...
                                            <tr class="hover-bg-neutral-20 transition-03">
                                                ...
                                                <td class="py-28 px-20 shadow-none">24</td>
                                            </tr>
                                            ...
                                            <tr class="hover-bg-neutral-20 transition-03">
                                                ...
                                                <td class="py-28 px-20 shadow-none">30</td>
                                            </tr>
                                            ...
                                            <tr class="hover-bg-neutral-20 transition-03">
                                                ...
                                                <td class="py-28 px-20 shadow-none">11</td>
                                            </tr>
                                            ...
                                            <tr class="hover-bg-neutral-20 transition-03">
                                                ...
                                                <td class="py-28 px-20 shadow-none">33</td>
                                            </tr>
                                            ...
                                            <tr class="hover-bg-neutral-20 transition-03">
                                                ...
                                                <td class="py-28 px-20 shadow-none">40</td>
                                            </tr>
                                            ...
                                            <tr class="hover-bg-neutral-20 transition-03">
                                                ...
                                                <td class="py-28 px-20 shadow-none">14</td>
                                            </tr>
                                            ...
                                            <tr class="hover-bg-neutral-20 transition-03">
                                                ...
                                                <td class="py-28 px-20 shadow-none">36</td>
                                            </tr>
                                            ...
                                            <tr class="hover-bg-neutral-20 transition-03">
                                                ...
                                                <td class="py-28 px-20 shadow-none">17</td>
                                            </tr>
                                            ...
                                            <tr class="hover-bg-neutral-20 transition-03">
                                                ...
                                                <td class="py-28 px-20 shadow-none">22</td>
                                            </tr>
                                            ...
                                            <tr class="hover-bg-neutral-20 transition-03">
                                                ...
                                                <td class="py-28 px-20 shadow-none">3</td>
                                            </tr>   
