        ...
        <div className="row justify-content-center">
            <div className="col-lg-8">
                <div className="breadcrumb__wrapper">
                    <h1 className="breadcrumb__title display-4 fw-semibold text-center"> Checkout</h1>
                    <ul className="breadcrumb__list d-flex align-items-center justify-content-center gap-4">
                        ...
                        <li className="breadcrumb__item"> 
                            <span className="text-main-two-600"> Checkout </span> 
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div className="row">
                        ...
                        <div className="border border-neutral-30 rounded-12 bg-main-25 p-32 bg-main-25">
                            ...
                            <div className="d-flex align-items-center justify-content-between">
                                <div className="text-neutral-500 text-md">
                                    Transaction ID: <span className="text-neutral-700">25246584</span>
                                </div>
                                <div className="text-neutral-500 text-md">
                                    Total Payable Amount: <span className="text-neutral-700">$1115</span>
                                </div>
                            </div>
                            ...
                            <div className="row gy-4">
                                <div className="col-sm-6 col-xs-6">
                                    <input type="text" className="common-input bg-white rounded-pill border-neutral-40 focus-border-main-600 placeholder-text-neutral-100" placeholder="Enter Name" />
                                </div>
                                <div className="col-sm-6 col-xs-6">
                                    <input type="email" className="common-input bg-white rounded-pill border-neutral-40 focus-border-main-600 placeholder-text-neutral-100"  placeholder="Enter Email" />
                                </div>
                                <div className="col-sm-6 col-xs-6">
                                    <input type="tel" className="common-input bg-white rounded-pill border-neutral-40 focus-border-main-600 placeholder-text-neutral-100"  placeholder="Enter Phone Number" />
                                </div>
                                <div className="col-sm-6 col-xs-6">
                                ...
                                <div className="col-sm-12">
                                    <textarea className="common-input bg-white rounded-24 border-neutral-40 focus-border-main-600 placeholder-text-neutral-100" placeholder="Enter address"></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="border border-neutral-30 rounded-12 bg-main-25 p-32 bg-main-25 mt-24">
                            ...
                            <div className="d-flex align-items-center gap-24 flex-wrap">
                                <div className="form-check common-check common-radio mb-0">
                                    <input className="form-check-input" type="radio" name="card" id="creditCard" />
                                    <label className="form-check-label fw-normal flex-grow-1" htmlFor="creditCard">Credit card</label>
                                </div>
                                <div className="form-check common-check common-radio mb-0">
                                    <input className="form-check-input" type="radio" name="card" id="Debitcard" />
                                    <label className="form-check-label fw-normal flex-grow-1" htmlFor="Debitcard">Debit card</label>
                                </div>
                                <div className="form-check common-check common-radio mb-0">
                                    <input className="form-check-input" type="radio" name="card" id="PayPal" />
                                    <label className="form-check-label fw-normal flex-grow-1" htmlFor="PayPal">PayPal</label>
                                </div>
                            </div>
                            ...
                            <div className="row gy-4">
                                <div className="col-sm-12">
                                    <label htmlFor="cardNumber" className="text-neutral-700 text-lg fw-medium mb-12">Card number</label>
                                    <input type="text" className="common-input bg-white rounded-pill border-neutral-40 focus-border-main-600 placeholder-text-neutral-100"  id="cardNumber" placeholder="2456 1665 5155 5151" />
                                </div>
                                <div className="col-sm-6 col-xs-6">
                                    <label htmlFor="Expirydate" className="text-neutral-700 text-lg fw-medium mb-12">Expiry date</label>
                                    <input type="date" className="common-input bg-white rounded-pill border-neutral-40 focus-border-main-600 placeholder-text-neutral-100" id="Expirydate" />
                                </div>
                                <div className="col-sm-6 col-xs-6">
                                    <label htmlFor="cvv" className="text-neutral-700 text-lg fw-medium mb-12">CVC / CVV</label>
                                    <input type="text" className="common-input bg-white rounded-pill border-neutral-40 focus-border-main-600 placeholder-text-neutral-100" id="cvv" placeholder="3 digits" />
                                </div>
                                <div className="col-sm-12">
                                    <label htmlFor="nameCard" className="text-neutral-700 text-lg fw-medium mb-12">Name on card</label>
                                    <input type="text" className="common-input bg-white rounded-pill border-neutral-40 focus-border-main-600 placeholder-text-neutral-100" id="nameCard" placeholder="Jab Archur" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-lg-4">
                        <div className="border border-neutral-30 rounded-12 bg-main-25 p-24 bg-main-25">
                            ...
                            <button type="submit" className="btn btn-main rounded-pill w-100 mt-40">
                                Check Out
                            </button>
                        </div>
                    </div>
