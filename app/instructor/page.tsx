...
{/* ==================== Breadcrumb End Here ==================== */}
        ...
        <a href="https://www.linkedin.com" className=" flex-center border border-white text-white w-44 h-44 rounded-circle text-xl hover-text-main hover-bg-white"><i className="ph-bold ph-instagram-logo"></i></a>
                            ...
                            <div className="">
                                <h4 className="mb-28 pb-24 border-bottom border-neutral-50 mb-24 border-dashed border-0">
                                    <a href="/instructor-details" className="link text-line-2">Devon Lane</a>
                                </h4>
                                <div className="flex-between gap-8 flex-wrap mb-16">
                                    <div className="flex-align gap-8">
                                        <span className="text-neutral-700 text-2xl d-flex"><i className="ph-bold ph-lightbulb"></i></span>
                                        <span className="text-neutral-700 text-lg fw-medium">Web Developer</span>
                                    </div>
                                    <div className="flex-align gap-8">
                                        <span className="text-neutral-700 text-2xl d-flex"><i className="ph-bold ph-watch"></i></span>
                                        <span className="text-neutral-700 text-lg fw-medium">7 Course</span>
                                    </div>
                                </div>
                                <div className="flex-between gap-8 flex-wrap">
                                    <div className="flex-align gap-8">
                                        ...
                                        <span className="text-neutral-700 text-lg fw-medium">15k Students</span>
                                    </div>
                            ...
                            <div className="pt-24 border-top border-neutral-50 mt-28 border-dashed border-0">
                                <a href="/instructor-details" className="flex-align gap-8 text-main-600 hover-text-decoration-underline transition-1 fw-semibold" tabIndex={0}>
                                    View Profile
    ...
    <li className="social-list__item">
        <a href="https://www.linkedin.com" className=" flex-center border border-white text-white w-44 h-44 rounded-circle text-xl hover-text-main hover-bg-white"><i className="ph-bold ph-instagram-logo"></i></a>
                            ...
                            <div className="">
                                <h4 className="mb-28 pb-24 border-bottom border-neutral-50 mb-24 border-dashed border-0">
                                    <a href="/instructor-details" className="link text-line-2">John Doe</a>
                                </h4>
                                <div className="flex-between gap-8 flex-wrap mb-16">
                                    <div className="flex-align gap-8">
                                        <span className="text-neutral-700 text-2xl d-flex"><i className="ph-bold ph-lightbulb"></i></span>
                                        <span className="text-neutral-700 text-lg fw-medium">WordPress Expert</span>
                                    </div>
                                    <div className="flex-align gap-8">
                                        <span className="text-neutral-700 text-2xl d-flex"><i className="ph-bold ph-watch"></i></span>
                                        <span className="text-neutral-700 text-lg fw-medium">6 Course</span>
                                    </div>
                                </div>
                                <div className="flex-between gap-8 flex-wrap">
                                    <div className="flex-align gap-8">
                                        <span className="text-neutral-700 text-2xl d-flex"><i className="ph-bold ph-users"></i></span>
                                        <span className="text-neutral-700 text-lg fw-medium">55k Students</span>
                                    </div>
                                    <div className="flex-align gap-4">
                                        <span className="text-2xl fw-medium text-warning-600 d-flex"><i className="ph-fill ph-star"></i></span>
                                        <span className="text-lg text-neutral-700">
    ...
    <li className="social-list__item">
        <a href="https://www.linkedin.com" className=" flex-center border border-white text-white w-44 h-44 rounded-circle text-xl hover-text-main hover-bg-white"><i className="ph-bold ph-instagram-logo"></i></a>
                            ...
                            <div className="">
                                <h4 className="mb-28 pb-24 border-bottom border-neutral-50 mb-24 border-dashed border-0">
                                    <a href="/instructor-details" className="link text-line-2">Alexandar</a>
                                </h4>
                                <div className="flex-between gap-8 flex-wrap mb-16">
                                    <div className="flex-align gap-8">
                                        <span className="text-neutral-700 text-2xl d-flex"><i className="ph-bold ph-lightbulb"></i></span>
    ...
    <li className="social-list__item">
        <a href="https://www.linkedin.com" className=" flex-center border border-white text-white w-44 h-44 rounded-circle text-xl hover-text-main hover-bg-white"><i className="ph-bold ph-instagram-logo"></i></a>
                            ...
                            <div className="">
                                <h4 className="mb-28 pb-24 border-bottom border-neutral-50 mb-24 border-dashed border-0">
                                    <a href="/instructor-details" className="link text-line-2">Arlene McCoy</a>
                                </h4>
                                <div className="flex-between gap-8 flex-wrap mb-16">
                                    <div className="flex-align gap-8">
                                        <span className="text-neutral-700 text-2xl d-flex"><i className="ph-bold ph-lightbulb"></i></span>
                                        <span className="text-neutral-700 text-lg fw-medium">Web Development</span>
                                    </div>
                                    <div className="flex-align gap-8">
                                        <span className="text-neutral-700 text-2xl d-flex"><i className="ph-bold ph-watch"></i></span>
                                        <span className="text-neutral-700 text-lg fw-medium">6 Course</span>
        ...
        <a href="https://www.linkedin.com" className=" flex-center border border-white text-white w-44 h-44 rounded-circle text-xl hover-text-main hover-bg-white"><i className="ph-bold ph-instagram-logo"></i></a>
                            ...
                            <div className="">
                                ...
                                <div className="flex-between gap-8 flex-wrap mb-16">
                                    <div className="flex-align gap-8">
                                        <span className="text-neutral-700 text-2xl d-flex"><i className="ph-bold ph-lightbulb"></i></span>
                                        <span className="text-neutral-700 text-lg fw-medium">Digital Marketing</span>
                                    </div>
                                    <div className="flex-align gap-8">
                                        <span className="text-neutral-700 text-2xl d-flex"><i className="ph-bold ph-watch"></i></span>
                                        <span className="text-neutral-700 text-lg fw-medium">12 Course</span>
                                ...
                                <div className="flex-between gap-8 flex-wrap">
                                    <div className="flex-align gap-8">
                                        <span className="text-neutral-700 text-2xl d-flex"><i className="ph-bold ph-users"></i></span>
                                        <span className="text-neutral-700 text-lg fw-medium">26k Students</span>
                                    </div>
                                    <div className="flex-align gap-4">
                                        <span className="text-2xl fw-medium text-warning-600 d-flex"><i className="ph-fill ph-star"></i></span>
                                        <span className="text-lg text-neutral-700">
    ...
    <li className="social-list__item">
        <a href="https://www.linkedin.com" className=" flex-center border border-white text-white w-44 h-44 rounded-circle text-xl hover-text-main hover-bg-white"><i className="ph-bold ph-instagram-logo"></i></a>
                            ...
                            <div className="">
                                <h4 className="mb-28 pb-24 border-bottom border-neutral-50 mb-24 border-dashed border-0">
                                    <a href="/instructor-details" className="link text-line-2">Kathryn Murphy</a>
                                </h4>
                                <div className="flex-between gap-8 flex-wrap mb-16">
                                    <div className="flex-align gap-8">
                                        <span className="text-neutral-700 text-2xl d-flex"><i className="ph-bold ph-lightbulb"></i></span>
                                        <span className="text-neutral-700 text-lg fw-medium">Graphic Design</span>
                                    </div>
                                    <div className="flex-align gap-8">
                                        <span className="text-neutral-700 text-2xl d-flex"><i className="ph-bold ph-watch"></i></span>
                                        <span className="text-neutral-700 text-lg fw-medium">5 Course</span>
                                    </div>
                                </div>
                                <div className="flex-between gap-8 flex-wrap">
                                    <div className="flex-align gap-8">
                                        <span className="text-neutral-700 text-2xl d-flex"><i className="ph-bold ph-users"></i></span>
                                        <span className="text-neutral-700 text-lg fw-medium">9k Students</span>
                                    </div>
                                    <div className="flex-align gap-4">
                                        <span className="text-2xl fw-medium text-warning-600 d-flex"><i className="ph-fill ph-star"></i></span>
                                        <span className="text-lg text-neutral-700">
