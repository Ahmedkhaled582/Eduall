...
export default function Page() {
  return (
    ...
    <section className="course-details py-120 bg-main-25">
        <div className="container">
            <div className="row gy-4">
                <div className="col-xl-8">
                    {/* Details Content Start */}
                    <div className="course-details__content border border-neutral-30 rounded-12 bg-white p-12">
                        <video id="player" className="player" playsInline controls data-poster="assets/images/thumbs/course-details-img.png">
                        ...
                        <a href="https://www.youtube.com/watch?v=MFLVmAE4cqg" className="play-button position-absolute start-50 top-50 translate-middle z-1 w-72 h-72 flex-center bg-main-two-600 text-white rounded-circle text-2xl" savefrom_lm_index="0">
                    ...
                    <div className="border border-neutral-30 rounded-12 bg-white p-32 mt-24">
                        ...
                        <div className="border border-neutral-30 rounded-12 bg-main-25 p-32">
                            ...
                            <div className="flex-align gap-20 mt-24">
                                ...
                                <input type="text" className="common-input rounded-pill bg-white border-neutral-30 py-16" placeholder="Join the discussion..." />
                            </div>
                        </div>
                        {/* Review Item */}
                    ...
                    <div className="border border-neutral-30 rounded-12 bg-white p-32 mt-24">
                        <form action="#" id="commentForm">
                            ...
                            <div className="mb-24">
                                ...
                                <input type="text" className="common-input bg-main-25 rounded-pill" id="name" placeholder="Enter Name..." />
                            </div>
                            <div className="mb-24">
                                <label htmlFor="email" className="text-neutral-700 text-lg fw-medium mb-12">Email </label>
                                <input type="email" className="common-input bg-main-25 rounded-pill" id="email" placeholder="Enter Email..." />
                            </div>
                            <div className="mb-24">
                            ...
                            <div className="mb-24">
                                ...
                                <textarea id="desc" className="common-input bg-main-25 rounded-24" placeholder="Write you question..."></textarea>
                            </div>
                            <div className="mb-0">
                        ...
                        <div className="accordion common-accordion style-three" id="accordionExampleTwo">
                            ...
                            <div className="accordion-item">
                              <h2 className="accordion-header bg-main-25">
                                <button className="accordion-button bg-main-25" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOneTwo" aria-expanded="true" aria-controls="collapseOneTwo">
                              ...
                              <div id="collapseOneTwo" className="accordion-collapse collapse show" data-bs-parent="#accordionExampleTwo">
                                <div className="accordion-body p-0 bg-main-25">
                                    <div className="curriculam-item">
                                        <a href="#" className="text-neutral-500 fw-medium hover-text-main-600 d-block">   
                                        ...
                                        <div className="flex-between gap-8 mt-24">
                                            <a href="/lesson-details" className="flex-align gap-8 text-main-600 hover-text-decoration-underline transition-1 fw-semibold" tabIndex={0}>
                                                View Profile
                                                <i className="ph ph-arrow-right"></i>
                                            </a>
                                            <span className="flex-align gap-12 flex-shrink-0">
                                                30:25
                                                <i className="text-xl d-flex ph ph-lock-key"></i>
                                            </span>
                                        </div>
                                    </div>
                                    <div className="curriculam-item">
                            ...
                            <div className="accordion-item">
                              <h2 className="accordion-header bg-main-25">
                                <button className="accordion-button bg-main-25 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwoTwo" aria-expanded="false" aria-controls="collapseTwoTwo">
                            ...
                            <div className="accordion-item">
                              <h2 className="accordion-header bg-main-25">
                                <button className="accordion-button bg-main-25 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThreeTwo" aria-expanded="false" aria-controls="collapseThreeTwo">
                                    Data Structures
                                </button>
                              </h2>
                            ...
                            <div className="accordion-item">
                              <h2 className="accordion-header bg-main-25">
                                <button className="accordion-button bg-main-25 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFourTwo" aria-expanded="false" aria-controls="collapseFourTwo">
                            ...
                            <div className="accordion-item">
                              <h2 className="accordion-header bg-main-25">
                                <button className="accordion-button bg-main-25 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFiveTwo" aria-expanded="false" aria-controls="collapseFiveTwo">
                            ...
                            <div className="accordion-item">
                              <h2 className="accordion-header bg-main-25">
                                <button className="accordion-button bg-main-25 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSixTwo" aria-expanded="false" aria-controls="collapseSixTwo">
                                    Project and Capstone
                                </button>
                              </h2>
                              <div id="collapseSixTwo" className="accordion-collapse collapse" data-bs-parent="#accordionExampleTwo">
                                <div className="accordion-body p-0 bg-main-25">
                                    <div className="curriculam-item">
                                        <a href="#" className="text-neutral-500 fw-medium hover-text-main-600 d-block">   
                                            <span className="flex-align gap-12">
