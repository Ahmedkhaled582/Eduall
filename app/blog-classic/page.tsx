        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="breadcrumb__wrapper">
                    <h1 class="breadcrumb__title display-4 fw-semibold text-center"> Blog Classic</h1>
                    <ul class="breadcrumb__list d-flex align-items-center justify-content-center gap-4">
                        ...
                        <li class="breadcrumb__item"> 
                            <span class="text-main-two-600"> Blog Classic </span> 
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="col-lg-8">
                    <div class="d-flex flex-column gap-24">
                        <div class="scale-hover-item bg-main-25 rounded-16 p-12 h-100 border border-neutral-30">
                            <div class="course-item__thumb max-h-unset rounded-12 overflow-hidden position-relative">
                                <a href="/blog-details" class="w-100 h-100">
                            ...
                            <div class="pt-32 pb-24 px-16 position-relative">
                                <h4 class="mb-28">
                                    <a href="/blog-details" class="link text-line-2">Navigating the Job Market: Advice for Graduates</a>
                                </h4>
                                ...
                                <div class="flex-between gap-8 pt-24 border-top border-neutral-50 mt-28 border-dashed border-0">
                                    <a href="/blog-details" class="flex-align gap-8 text-main-600 hover-text-decoration-underline transition-1 fw-semibold" tabindex="0">
                                        Read More
                        ...
                        <div class="scale-hover-item bg-main-25 rounded-16 p-12 h-100 border border-neutral-30">
                            ...
                            <div class="pt-32 pb-24 px-16 position-relative">
                                <h4 class="mb-28">
                                    <a href="/blog-details" class="link text-line-2">The Importance of Diversity in Higher Education</a>
                                </h4>
                                <div class="flex-align gap-14 flex-wrap my-20">
                                    <div class="flex-align gap-8">
                                        <span class="text-neutral-500 text-2xl d-flex"><i class="ph ph-user-circle"></i></span>
                        ...
                        <div class="scale-hover-item bg-main-25 rounded-16 p-12 h-100 border border-neutral-30">
                            ...
                            <div class="pt-32 pb-24 px-16 position-relative">
                                <h4 class="mb-28">
                                    <a href="/blog-details" class="link text-line-2">10 Tips for Successful Online Learning</a>
                                </h4>
                                <div class="flex-align gap-14 flex-wrap my-20">
                                    <div class="flex-align gap-8">
                                        <span class="text-neutral-500 text-2xl d-flex"><i class="ph ph-user-circle"></i></span>
                        ...
                        <div class="scale-hover-item bg-main-25 rounded-16 p-12 h-100 border border-neutral-30">
                            <div class="course-item__thumb max-h-unset rounded-12 overflow-hidden position-relative">
                                <a href="/blog-details" class="w-100 h-100">
                                    <img src="/assets/images/thumbs/blog-two-img4.png" alt="Course Image" class="scale-hover-item__img rounded-12 cover-img transition-2">
                                </a>
                                <div class="position-absolute inset-inline-end-0 inset-block-end-0 me-16 mb-16 py-12 px-24 rounded-8 bg-main-two-600 text-white fw-medium">
                                    <h3 class="mb-0 text-white fw-medium">21</h3>
                                    DEC
                            ...
                            <div class="pt-32 pb-24 px-16 position-relative">
                                <h4 class="mb-28">
                                    <a href="/blog-details" class="link text-line-2">How to Stay Motivated While Studying from Home</a>
                                </h4>
                                <div class="flex-align gap-14 flex-wrap my-20">
                                    <div class="flex-align gap-8">
                                        <span class="text-neutral-500 text-2xl d-flex"><i class="ph ph-user-circle"></i></span>
                        ...
                        <div class="scale-hover-item bg-main-25 rounded-16 p-12 h-100 border border-neutral-30">
                            <div class="course-item__thumb max-h-unset rounded-12 overflow-hidden position-relative">
                                <a href="/blog-details" class="w-100 h-100">
                                    <img src="/assets/images/thumbs/blog-two-img5.png" alt="Course Image" class="scale-hover-item__img rounded-12 cover-img transition-2">
                                </a>
                                <div class="position-absolute inset-inline-end-0 inset-block-end-0 me-16 mb-16 py-12 px-24 rounded-8 bg-main-two-600 text-white fw-medium">
                                    <h3 class="mb-0 text-white fw-medium">21</h3>
                                    DEC
                            ...
                            <div class="pt-32 pb-24 px-16 position-relative">
                                <h4 class="mb-28">
                                    <a href="/blog-details" class="link text-line-2">Mastering Python: Beginner to Advanced Tips</a>
                                </h4>
                                <div class="flex-align gap-14 flex-wrap my-20">
                                    <div class="flex-align gap-8">
                                        <span class="text-neutral-500 text-2xl d-flex"><i class="ph ph-user-circle"></i></span>
                        ...
                        <div class="scale-hover-item bg-main-25 rounded-16 p-12 h-100 border border-neutral-30">
                            <div class="course-item__thumb max-h-unset rounded-12 overflow-hidden position-relative">
                                <a href="/blog-details" class="w-100 h-100">
                                    <img src="/assets/images/thumbs/blog-two-img6.png" alt="Course Image" class="scale-hover-item__img rounded-12 cover-img transition-2">
                                </a>
                                <div class="position-absolute inset-inline-end-0 inset-block-end-0 me-16 mb-16 py-12 px-24 rounded-8 bg-main-two-600 text-white fw-medium">
                                    <h3 class="mb-0 text-white fw-medium">21</h3>
                                    DEC
                            ...
                            <div class="pt-32 pb-24 px-16 position-relative">
                                <h4 class="mb-28">
                                    <a href="/blog-details" class="link text-line-2">Balancing Work and Study: Strategies for Success</a>
                                </h4>
                                <div class="flex-align gap-14 flex-wrap my-20">
                                    <div class="flex-align gap-8">
                                        <span class="text-neutral-500 text-2xl d-flex"><i class="ph ph-user-circle"></i></span>
                        ...
                        <div class="scale-hover-item bg-main-25 rounded-16 p-12 h-100 border border-neutral-30">
                            <div class="course-item__thumb max-h-unset rounded-12 overflow-hidden position-relative">
                                <a href="/blog-details" class="w-100 h-100">
                                    <img src="/assets/images/thumbs/blog-two-img7.png" alt="Course Image" class="scale-hover-item__img rounded-12 cover-img transition-2">
                                </a>
                                <div class="position-absolute inset-inline-end-0 inset-block-end-0 me-16 mb-16 py-12 px-24 rounded-8 bg-main-two-600 text-white fw-medium">
                                    <h3 class="mb-0 text-white fw-medium">21</h3>
                                    DEC
                            ...
                            <div class="pt-32 pb-24 px-16 position-relative">
                                <h4 class="mb-28">
                                    <a href="/blog-details" class="link text-line-2">The Importance of Lifelong Learning in Today's World</a>
                                </h4>
                                <div class="flex-align gap-14 flex-wrap my-20">
                                    <div class="flex-align gap-8">
                                        <span class="text-neutral-500 text-2xl d-flex"><i class="ph ph-user-circle"></i></span>
                        ...
                        <div class="scale-hover-item bg-main-25 rounded-16 p-12 h-100 border border-neutral-30">
                            <div class="course-item__thumb max-h-unset rounded-12 overflow-hidden position-relative">
                                <a href="/blog-details" class="w-100 h-100">
                                    <img src="/assets/images/thumbs/blog-two-img8.png" alt="Course Image" class="scale-hover-item__img rounded-12 cover-img transition-2">
                                </a>
                                <div class="position-absolute inset-inline-end-0 inset-block-end-0 me-16 mb-16 py-12 px-24 rounded-8 bg-main-two-600 text-white fw-medium">
                                    <h3 class="mb-0 text-white fw-medium">21</h3>
                                    DEC
                            ...
                            <div class="pt-32 pb-24 px-16 position-relative">
                                <h4 class="mb-28">
                                    <a href="/blog-details" class="link text-line-2">Effective Time Management for Students</a>
                                </h4>
                                <div class="flex-align gap-14 flex-wrap my-20">
                                    <div class="flex-align gap-8">
                                        <span class="text-neutral-500 text-2xl d-flex"><i class="ph ph-user-circle"></i></span>
                        ...
                        <div class="scale-hover-item bg-main-25 rounded-16 p-12 h-100 border border-neutral-30">
                            <div class="course-item__thumb max-h-unset rounded-12 overflow-hidden position-relative">
                                <a href="/blog-details" class="w-100 h-100">
                                    <img src="/assets/images/thumbs/blog-two-img9.png" alt="Course Image" class="scale-hover-item__img rounded-12 cover-img transition-2">
                                </a>
                                <div class="position-absolute inset-inline-end-0 inset-block-end-0 me-16 mb-16 py-12 px-24 rounded-8 bg-main-two-600 text-white fw-medium">
                                    <h3 class="mb-0 text-white fw-medium">21</h3>
                                    DEC
                            ...
                            <div class="pt-32 pb-24 px-16 position-relative">
                                <h4 class="mb-28">
                                    <a href="/blog-details" class="link text-line-2">The Benefits of Learning a New Language Online</a>
                                </h4>
                                <div class="flex-align gap-14 flex-wrap my-20">
                                    <div class="flex-align gap-8">
                                        <span class="text-neutral-500 text-2xl d-flex"><i class="ph ph-user-circle"></i></span>
