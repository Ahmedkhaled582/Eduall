...
import InstructorEnrolledCoursesSection from '@/components/dashboard/InstructorEnrolledCoursesSection';
      ...
      <section className="bg-main-25 pb-80 w-100 h-100">
        <div className="container container--lg">
          <div className="d-flex gap-24 mt--120 z-2 position-relative">
            ...
            <InstructorSidebar activeItem="enrolled" />
            <InstructorEnrolledCoursesSection />
          </div>            
        </div>
      </section>
