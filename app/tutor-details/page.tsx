...
<!-- ==================== Breadcrumb End Here ==================== -->
    ...
    <section class="tutor-details py-120">
        <div class="container">
            <div class="row gy-4">
                <div class="col-lg-4">
                    <div class="border border-neutral-30 rounded-12 bg-white p-8">
                        <div class="border border-neutral-30 rounded-12 bg-main-25 p-32 bg-main-25">
                            <div class="p-16 border border-neutral-50 rounded-circle aspect-ratio-1 max-w-150 max-h-150 mx-auto">
                                <div class="position-relative">
                                    <img src="/assets/images/thumbs/instructor-img1.png" alt="" class="rounded-circle bg-dark-yellow aspect-ratio-1 cover-img">
                                    <span class="w-32 h-32 bg-success-600 rounded-circle border border-main-25 border-3 flex-center text-white position-absolute inset-block-end-0 inset-inline-end-0 me-4">
                                        <i class="ph-bold ph-check"></i>
                                    </span>
                                </div>
                            </div>
                            <h4 class="mb-16 text-center mt-40">Savannah Nguyen</h4>
                            <div class="flex-center gap-10 flex-wrap my-20">
                                <span class="text-neutral-500 text-md">ID: <span class="text-main-600 fw-medium">TS-950</span></span>
                                <span class="w-4 h-4 bg-main-600 rounded-circle"></span>
                                <span class="text-neutral-500 text-md">Gender: <span class="text-main-600 fw-medium">Male </span></span>
                                <span class="w-4 h-4 bg-main-600 rounded-circle"></span>
                                <div class="flex-align gap-4">
                                    <span class="text-lg fw-medium text-warning-600 d-flex"><i class="ph-fill ph-star"></i></span>
                                    <span class="text-md text-neutral-700">
                                        4.8
                                        <span class="text-neutral-100"> (114)</span>
                                    </span>
                                </div>
                            </div>
                            <ul class="social-list flex-center gap-16 mt-28">
                            ...
                            <div class="d-flex flex-column gap-16">
                                <div class="flex-align gap-16">
                                    <span class="text-2xl text-main-600">
                                        <i class="ph-bold ph-phone-call"></i>
                                    </span>
                                    <a href="tel:252555-0126" class="text-neutral-700 hover-text-main-600">(252) 555-0126</a>
                                </div>
                                <div class="flex-align gap-16">
                                    <span class="text-2xl text-success-600">
                                        <i class="ph-bold ph-envelope-simple"></i>
                                    </span>
                                    <a href="mailto:demo@gmail.com" class="text-neutral-700 hover-text-main-600">demo@gmail.com</a>
                                </div>
                                <div class="flex-align gap-16">
                                    <span class="text-2xl text-warning-600">
                                        <i class="ph-bold ph-map-pin-line"></i>
                                    </span>
                                    <span class="text-neutral-700">2715 Ash Dr. San Jose, South Dakota</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="border border-neutral-30 rounded-12 bg-white p-8 mt-24">
                        <div class="border border-neutral-30 rounded-12 bg-main-25 p-32 bg-main-25">
                            ...
                            <form action="#" class="d-flex flex-column gap-20">
                                <div class="">
                                    <label for="myName" class="text-lg fw-semibold text-neutral-700 mb-8">Name</label>
                                    <input type="text" class="common-input border-transparent rounded-pill focus-border-main-600" id="myName" placeholder="Enter Your Name...">
                                </div>
                                <div class="">
                                    <label for="Email" class="text-lg fw-semibold text-neutral-700 mb-8">Email</label>
                                    <input type="email" class="common-input border-transparent rounded-pill focus-border-main-600" id="Email" placeholder="Enter Your Email...">
                                </div>
                                <div class="">
                                    <label for="Phone" class="text-lg fw-semibold text-neutral-700 mb-8">Phone</label>
                                    <input type="tel" class="common-input border-transparent rounded-pill focus-border-main-600" id="Phone" placeholder="Enter Your Number...">
                                </div>
                                <div class="">
                                    <label for="Message" class="text-lg fw-semibold text-neutral-700 mb-8">Message</label>
                                    <textarea class="common-input border-transparent rounded-24 focus-border-main-600" id="Message" placeholder="Enter Your Message..."></textarea>
                                </div>
                                <div class="">
                                    <button type="submit" class="btn btn-main rounded-pill flex-center gap-8 mt-20">
                                        Submit Review
                ...
                <div class="col-lg-8">
                    ...
                    <ul class="nav nav-pills common-tab d-inline-flex gap-16 bg-white p-12 border border-neutral-30 rounded-pill" id="pills-tab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link rounded-pill bg-main-25 text-md fw-medium text-neutral-500 flex-center w-100 gap-8 active" id="pills-tutionInfo-tab" data-bs-toggle="pill" data-bs-target="#pills-tutionInfo" type="button" role="tab" aria-controls="pills-tutionInfo" aria-selected="true">
                                <i class="text-xl text-main-600 d-flex ph-bold ph-user"></i>
                                Tuition Info
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link rounded-pill bg-main-25 text-md fw-medium text-neutral-500 flex-center w-100 gap-8" id="pills-qualification-tab" data-bs-toggle="pill" data-bs-target="#pills-qualification" type="button" role="tab" aria-controls="pills-qualification" aria-selected="false">
                                <i class="text-xl text-main-600 d-flex ph-bold ph-graduation-cap"></i>
                                Qualification
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link rounded-pill bg-main-25 text-md fw-medium text-neutral-500 flex-center w-100 gap-8" id="pills-reviews-tab" data-bs-toggle="pill" data-bs-target="#pills-reviews" type="button" role="tab" aria-controls="pills-reviews" aria-selected="false">
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        <div class="tab-pane fade show active" id="pills-tutionInfo" role="tabpanel" aria-labelledby="pills-tutionInfo-tab" tabindex="0">
                             <!-- Tuition Info Start -->
                             <div class="tutor-details__content">
                                <div class="border border-neutral-30 rounded-12 bg-white p-8 mt-24">
                                    <div class="border border-neutral-30 rounded-12 bg-main-25 p-32 bg-main-25">
                                        <h4 class="mb-16">Tuition Info</h4>
                                        <span class="d-block border border-neutral-30 my-24 border-dashed"></span>
                                        <ul class="tution-info-list bg-white rounded-8">
                                            <li class="d-flex align-items-start px-32 py-16">
                                                <span class="w-50-percent fw-semibold text-neutral-700">Expected Minimum Salary</span>
                                                <span class="w-50-percent fw-normal text-neutral-500 text-md"> <span class="text-main-600 fw-semibold ">$400 </span> per month </span>
                                            </li>
                                            <li class="d-flex align-items-start px-32 py-16">
                                                <span class="w-50-percent fw-semibold text-neutral-700">Expected Minimum Salary</span>
                                                <span class="w-50-percent fw-semibold text-warning-600 text-md">Available</span>
                                            </li>
                                            <li class="d-flex align-items-start px-32 py-16">
                                                <span class="w-50-percent fw-semibold text-neutral-700">Days Per Week</span>
                                                <span class="w-50-percent fw-normal text-neutral-500 text-md"> 4 Day/Week</span>
                                            </li>
                                            <li class="d-flex align-items-start px-32 py-16">
                                                <span class="w-50-percent fw-semibold text-neutral-700">Preferred Tuition Style</span>
                                                <span class="w-50-percent fw-normal text-neutral-500 text-md"> Private Tuition, Online Tuition</span>
                                            </li>
                                            <li class="d-flex align-items-start px-32 py-16">
                                                <span class="w-50-percent fw-semibold text-neutral-700">Tuitoring Experience</span>
                                                <span class="w-50-percent fw-normal text-neutral-500 text-md"> 6 Years</span>
                                            </li>
                                            <li class="d-flex align-items-start px-32 py-16">
                                                <span class="w-50-percent fw-semibold text-neutral-700">Place of Learning</span>
                                                <span class="w-50-percent fw-normal text-neutral-500 text-md"> Home Visit</span>
                                            </li>
                                            <li class="d-flex align-items-start px-32 py-16">
                                                <span class="w-50-percent fw-semibold text-neutral-700">Extra Facilities</span>
                                                <span class="w-50-percent fw-normal text-neutral-500 text-md"> Phone help</span>
                                            </li>
                                            <li class="d-flex align-items-start px-32 py-16">
                                                <span class="w-50-percent fw-semibold text-neutral-700">Preferred Medium of Instruction</span>
                                                <span class="w-50-percent fw-normal text-neutral-500 text-md"> Bangla Medium, English Version</span>
                                            </li>
                                            <li class="d-flex align-items-start px-32 py-16">
                                                <span class="w-50-percent fw-semibold text-neutral-700">Preferred Class</span>
                                            ...
                                            <li class="d-flex align-items-start px-32 py-16">
                                                ...
                                                <span class="w-50-percent fw-normal text-neutral-500 text-md"> Evening, After Magrib</span>
                                            </li>
                                            <li class="d-flex align-items-start px-32 py-16">
                                                <span class="w-50-percent fw-semibold text-neutral-700">Preferred Area to Teach</span>
                                                <span class="w-50-percent fw-normal text-neutral-500 text-md"> 2464 Royal Ln. Mesa, New Jersey 45463</span>
                                            </li>
                                            <li class="d-flex align-items-start px-32 py-16">
                                                <span class="w-50-percent fw-semibold text-neutral-700">Student Reviews</span>
                        ...
                        <div class="tab-pane fade" id="pills-qualification" role="tabpanel" aria-labelledby="pills-qualification-tab" tabindex="0">
                            <!-- Qualification Start -->
                            <div class="tutor-details__content">
                                <div class="border border-neutral-30 rounded-12 bg-white p-8 mt-24">
                                    <div class="border border-neutral-30 rounded-12 bg-main-25 p-32 bg-main-25">
                                        <h4 class="mb-16">Educational Qualification</h4>
                                        <span class="d-block border border-neutral-30 my-24 border-dashed"></span>

                                        <div class="overflow-x-auto">
                                            <ul class="tution-info-list style-two bg-white rounded-8 border border-white border-2 rounded-12">
                                                <li class="px-32 py-16">
                                                    <span class="fw-semibold text-neutral-700">Exam Name</span>
                                                    <span class="fw-semibold text-neutral-700">Year</span>
                                                    <span class="fw-semibold text-neutral-700">Institute</span>
                                                    <span class="fw-semibold text-neutral-700">Group/Subject</span>
                                                    <span class="fw-semibold text-neutral-700">Result</span>
                                                </li>
                                                <li class="px-32 py-16">
                                                    <span class="fw-normal text-neutral-700">SSC / O-level / Dakhil</span>
                                                    <span class="fw-normal text-neutral-700">2015</span>
                                                    <span class="fw-normal text-neutral-700">Birshreshtha Munshi Abdur Rouf public College</span>
                                                    <span class="fw-normal text-neutral-700">Science</span>
                                                    <span class="fw-normal text-main-600 text-md">5.00</span>
                                                </li>
                                                <li class="px-32 py-16">
                                                    <span class="fw-normal text-neutral-700">HSC / A level / Alim</span>
                                                    <span class="fw-normal text-neutral-700">2017</span>
                                                    <span class="fw-normal text-neutral-700">Birshreshtha Noor Mohammad Public College</span>
                                                    <span class="fw-normal text-neutral-700">Science</span>
                                                    <span class="fw-normal text-main-600 text-md">5.00</span>
                                                </li>
                                                <li class="px-32 py-16">
                                                    <span class="fw-normal text-neutral-700">Graduation / Bachelor / Diploma</span>
                                                    <span class="fw-normal text-neutral-700">Graduation Complete</span>
                                                    <span class="fw-normal text-neutral-700">Sher-e-Bangla Agricultural University</span>
                                                    <span class="fw-normal text-neutral-700">null</span>
                                                    <span class="fw-normal text-main-600 text-md">3.30 </span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div class="border border-neutral-30 rounded-12 bg-white p-8 mt-24">
                                    ...
                                    <div class="border border-neutral-30 rounded-12 bg-main-25 p-32 mt-24">
                                        <form action="#" id="commentForm">
                                            ...
                                            <span class="d-block border border-neutral-30 my-32 border-dashed"></span>
                                            <div class="mb-24">
                                                <label for="nameee" class="text-neutral-700 text-lg fw-medium mb-12">Name </label>
                                                <input type="text" class="common-input rounded-pill" id="nameee" placeholder="Enter Name...">
                                            </div>
                                            <div class="mb-24">
                                                <label for="email" class="text-neutral-700 text-lg fw-medium mb-12">Email </label>
                                                <input type="text" class="common-input rounded-pill" id="email" placeholder="Enter Email...">
                                            </div>
                                            <div class="mb-24">
