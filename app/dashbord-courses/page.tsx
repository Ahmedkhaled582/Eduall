...
<!-- =====message nab end======== -->
        <!-- =========message profile start=========== -->
            <div class="px-24 py-24">
                <div class="d-flex align-items-center gap-16 justify-content-between flex-wrap mb-24">
                    <h4 class="text-neutral-500 fw-semibold">Courses</h4>
                    <div class="d-flex align-items-center gap-8">

                        <ul class="nav nav-pills common-tab gap-16" id="pills-tab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link rounded-pill bg-white text-md fw-medium text-neutral-500 flex-center w-100 gap-8 active" id="pills-categories-tab" data-bs-toggle="pill" data-bs-target="#pills-categories" type="button" role="tab" aria-controls="pills-categories" aria-selected="true">
                                    Publish
                                </button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link rounded-pill bg-white text-md fw-medium text-neutral-500 flex-center w-100 gap-8" id="pills-design-tab" data-bs-toggle="pill" data-bs-target="#pills-design" type="button" role="tab" aria-controls="pills-design" aria-selected="false">
                                    Pending
                                </button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link rounded-pill bg-white text-md fw-medium text-neutral-500 d-flex justify-content-center align-items-center w-100 gap-2" id="pills-webDesign-tab" data-bs-toggle="pill" data-bs-target="#pills-webDesign" type="button" role="tab" aria-controls="pills-webDesign" aria-selected="false">
                                    Draft
                                </button>
                            </li>                        
                        </ul>
                ...
                <div class="tab-content" id="pills-tabContent">
                    ...
                    <div class="tab-pane fade show active" id="pills-categories"
                     role="tabpanel" aria-labelledby="pills-categories-tab" tabindex="0">
                        <div class="row gy-4">

    <div class="col-xl-3 col-md-6 col-sm-6 wow fadeInUp" data-aos="fade-up" data-aos-duration="600">
        <div class="course-item bg-white rounded-16 p-12 h-100 box-shadow-md">
            ...
            <div class="course-item__content">
                ...
                <div class="flex-between gap-8 pt-24 border-top border-neutral-50 mt-28 flex-wrap">
                    <div>
    ...
    <div class="col-xl-3 col-md-6 col-sm-6 wow fadeInUp" data-aos="fade-up" data-aos-duration="700">
        <div class="course-item bg-white rounded-16 p-12 h-100 box-shadow-md">
            <div class="course-item__thumb rounded-12 overflow-hidden">
                <a href="/course-details" class="w-100 h-100">
    ...
    <div class="col-xl-3 col-md-6 col-sm-6 wow fadeInUp" data-aos="fade-up" data-aos-duration="800">
        <div class="course-item bg-white rounded-16 p-12 h-100 box-shadow-md">
            <div class="course-item__thumb rounded-12 overflow-hidden">
                <a href="/course-details" class="w-100 h-100">
    ...
    <div class="col-xl-3 col-md-6 col-sm-6 wow fadeInUp" data-aos="fade-up" data-aos-duration="900">
        <div class="course-item bg-white rounded-16 p-12 h-100 box-shadow-md">
            <div class="course-item__thumb rounded-12 overflow-hidden">
                <a href="/course-details" class="w-100 h-100">
        ...
        <div class="course-item bg-white rounded-16 p-12 h-100 box-shadow-md">
            ...
            <div class="course-item__content">
                ...
                <div class="flex-between gap-8 pt-24 border-top border-neutral-50 mt-28 flex-wrap">
                    ...
                    <div class="d-flex align-items-center gap-8">
                        <img src="/assets/images/thumbs/user-two-img4.png" alt="" class="w-28 h-28">
    ...
    <div class="col-xl-3 col-md-6 col-sm-6 wow fadeInUp" data-aos="fade-up" data-aos-duration="800">
        <div class="course-item bg-white rounded-16 p-12 h-100 box-shadow-md">
            ...
            <div class="mb-24">
                <ul class="d-flex align-items-center gap-12 text-center align-items-center justify-content-center">
                    <li class="bg-white border-neutral-30 border w-40 h-40 rounded-circle text-24 align-items-center justify-content-center d-flex text-neutral-700 hover-bg-main-600 hover-text-white transition-04">
