            ...
            <div class="row gy-4">
                <div class="col-xl-4 col-sm-6">
                    <div class="scale-hover-item bg-main-25 rounded-16 p-12 h-100 border border-neutral-30">
                        <div class="course-item__thumb rounded-12 overflow-hidden position-relative">
                            <a href="/event-details" class="w-100 h-100" tabindex="0">
                        ...
                        <div class="pt-32 pb-24 px-16 position-relative">
                            <h4 class="mb-28">
                                <a href="/event-details" class="link text-line-2" tabindex="0">Career Guidance Workshops for Students</a>
                            </h4>
                            <div class="flex-align gap-8">
                            ...
                            <div class="flex-between gap-8 pt-24 border-top border-neutral-50 mt-28 border-dashed border-0">
                                ...
                                <a href="/event-details" class="flex-align gap-8 text-main-600 hover-text-decoration-underline transition-1 fw-semibold" tabindex="0">
                                    Join Now
                ...
                <div class="col-xl-4 col-sm-6">
                    <div class="scale-hover-item bg-main-25 rounded-16 p-12 h-100 border border-neutral-30">
                        ...
                        <div class="pt-32 pb-24 px-16 position-relative">
                            <h4 class="mb-28">
                                <a href="/event-details" class="link text-line-2" tabindex="0">Intensive Coding Bootcamps for Beginners</a>
                            </h4>
                            <div class="flex-align gap-8">
                                <span class="text-neutral-500 text-2xl d-flex"><i class="ph-bold ph-map-pin-line"></i></span>
                                <p class="text-neutral-500 text-lg">1901 Thornridge Cir. Shiloh</p>
                ...
                <div class="col-xl-4 col-sm-6">
                    <div class="scale-hover-item bg-main-25 rounded-16 p-12 h-100 border border-neutral-30">
                        ...
                        <div class="pt-32 pb-24 px-16 position-relative">
                            <h4 class="mb-28">
                                <a href="/event-details" class="link text-line-2" tabindex="0">Interactive Science Fair and Competition</a>
                            </h4>
                            <div class="flex-align gap-8">
                                <span class="text-neutral-500 text-2xl d-flex"><i class="ph-bold ph-map-pin-line"></i></span>
                                <p class="text-neutral-500 text-lg">1901 Thornridge Cir. Shiloh</p>
                ...
                <div class="col-xl-4 col-sm-6">
                    <div class="scale-hover-item bg-main-25 rounded-16 p-12 h-100 border border-neutral-30">
                        ...
                        <div class="pt-32 pb-24 px-16 position-relative">
                            <h4 class="mb-28">
                                <a href="/event-details" class="link text-line-2" tabindex="0">Mathematics Olympiad for Young Mathematicians</a>
                            </h4>
                            <div class="flex-align gap-8">
                                <span class="text-neutral-500 text-2xl d-flex"><i class="ph-bold ph-map-pin-line"></i></span>
                                <p class="text-neutral-500 text-lg">1901 Thornridge Cir. Shiloh</p>
                ...
                <div class="col-xl-4 col-sm-6">
                    <div class="scale-hover-item bg-main-25 rounded-16 p-12 h-100 border border-neutral-30">
                        ...
                        <div class="pt-32 pb-24 px-16 position-relative">
                            <h4 class="mb-28">
                                <a href="/event-details" class="link text-line-2" tabindex="0">The Importance of Diversity in Higher Education</a>
                            </h4>
                            <div class="flex-align gap-8">
                                <span class="text-neutral-500 text-2xl d-flex"><i class="ph-bold ph-map-pin-line"></i></span>
                                <p class="text-neutral-500 text-lg">1901 Thornridge Cir. Shiloh</p>
                ...
                <div class="col-xl-4 col-sm-6">
                    <div class="scale-hover-item bg-main-25 rounded-16 p-12 h-100 border border-neutral-30">
                        ...
                        <div class="pt-32 pb-24 px-16 position-relative">
                            <h4 class="mb-28">
                                <a href="/event-details" class="link text-line-2" tabindex="0">Virtual Open House for New Students</a>
                            </h4>
                            <div class="flex-align gap-8">
                                <span class="text-neutral-500 text-2xl d-flex"><i class="ph-bold ph-map-pin-line"></i></span>
                                <p class="text-neutral-500 text-lg">1901 Thornridge Cir. Shiloh</p>
