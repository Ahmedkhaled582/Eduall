    ...
    <li class="nav-menu__item has-submenu">
        <a href="javascript:void(0)" class="nav-menu__link">Dashboard</a>
         <ul class="nav-submenu scroll-sm">
            ...
            <li class="nav-submenu__item">
                <a href="/student-dashbord-my-profile" class="nav-submenu__link hover-bg-neutral-30">Student Dashbord My Profile</a>
            </li>
            <li class="nav-submenu__item">
                <a href="/student-dashbord-message" class="nav-submenu__link hover-bg-neutral-30">Student Dashbord Message</a>
            </li>
            <li class="nav-submenu__item">
                <a href="/student-dashbord-enrolled-courses" class="nav-submenu__link hover-bg-neutral-30">Student Dashbord Enrolled Courses</a>
            </li>
            <li class="nav-submenu__item">
                <a href="/student-dashbord-wishlist" class="nav-submenu__link hover-bg-neutral-30">Student Dashbord Wishlist</a>
            </li>
            <li class="nav-submenu__item">
                <a href="/student-dashbord-reviews" class="nav-submenu__link hover-bg-neutral-30">Student Dashbord Reviews</a>
            </li>
            <li class="nav-submenu__item">
                <a href="/student-dashbord-my-quiz-attempts" class="nav-submenu__link hover-bg-neutral-30">Student Dashbord My Quiz Attempts</a>
            </li>
            <li class="nav-submenu__item">
                <a href="/student-dashbord-assignment" class="nav-submenu__link hover-bg-neutral-30">Student Dashbord Assignment</a>
            </li>
            <li class="nav-submenu__item">
                <a href="/student-dashbord-settings" class="nav-submenu__link hover-bg-neutral-30">Student Dashbord Settings</a>
            </li>
        </ul>
    </li>
    <li class="nav-menu__item has-submenu">
