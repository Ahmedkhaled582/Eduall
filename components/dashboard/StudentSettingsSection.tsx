    ...
    <div className="w-100 overflow-y-auto">
      <div className="px-40 py-40 bg-white rounded-10 mb-24">
        ...
        <div className="mt-24">
          ...
          <form action="#" className="border-bottom-dashed-main pb-24">
            <div className="avatar-upload">
              <div className="d-flex align-items-center gap-40 flex-wrap">
                <div className="avatar-preview flex-shrink-0">
                  <div id="imagenextPreview" style={{"backgroundImage":"url(assets/images/thumbs/student-dashbord-profile-photo-img1.png)"}} className="">
                  </div>
                </div>
                ...
                <div className="d-flex align-items-center gap-16 flex-wrap">
                  <label htmlFor="imageUpload" className="bg-main-600 px-24 py-12 rounded-12 fw-semibold text-16 text-white transition-04 hover-bg-main-700">Upload Image</label>
          ...
          <div>
            <div className="mb-40">
              ...
              <div className="form-check common-check mb-0">
                <input className="form-check-input rounded-circle" type="checkbox" name="tutorType2" id="collage2" />
                <label className="form-check-label fw-normal flex-grow-1" htmlFor="collage2">I agree with all terms & conditions</label>
              </div>
            </div>
      ...
      <div className="px-40 py-40 bg-white rounded-10">
        ...
        <div className="mt-24">
          <div className="mb-40">
            ...
            <div className="form-check common-check mb-0">
              <input className="form-check-input rounded-circle" type="checkbox" name="tutorDeleteConfirm" id="school-Collage" />
