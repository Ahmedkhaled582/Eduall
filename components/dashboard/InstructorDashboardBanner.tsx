...
export default function InstructorDashboardBanner() {
  return (
    <>
      {/* ============== instructor dashbord banner section start =============== */}
      <section className="breadcrumb pt-80 pb-187 bg-neutral-900 position-relative z-1 overflow-hidden mb-0 z-n1">
        ...
        <img src="/assets/images/shapes/shape6.png" alt="" className="animation-scalation inset-inline-end-2-persent inset-block-start-2-persent position-absolute" />
        
        <div className="container container--lg">
          <div className="d-flex align-items-center gap-16 justify-content-between flex-wrap">
            <div className="breadcrumb__wrapper">
              <h1 className="breadcrumb__title display-4 fw-semibold text-white mb-20">Instructor Dashboard</h1>
              <ul className="breadcrumb__list d-flex align-items-center gap-4 flex-wrap">
                ...
                <li className="breadcrumb__item"> 
                  <span className="text-main-two-600">Instructor Dashboard</span> 
                </li>
              </ul>
            </div>
            <div>
      ...
      {/* ============== instructor dashbord banner section end =============== */}
    </>
  );
}
