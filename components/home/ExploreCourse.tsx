    ...
    <div className="container">
        <div className="section-heading text-center style-flex gap-24">
            <div className="section-heading__inner text-start">
                <h2 className="mb-0 wow bounceIn">Explore 4,000+ Free Online Courses For Students</h2>
            </div>
            <div className="section-heading__content">
                <p className="section-heading__desc text-start mt-0 text-line-2 wow bounceInUp">Welcome to our diverse and dynamic course catalog. we're dedicated to providing you...</p>
                <a href="/course-list-view" className="item-hover__text flex-align gap-8 text-main-600 mt-24 hover-text-decoration-underline transition-1" tabIndex={0}>
                    See All Course
        ...
        <div className="nav-tab-wrapper bg-white p-16 mb-40"  data-aos="zoom-out">
