            ...
            <div className="row gy-xl-0 gy-5 flex-wrap-reverse align-items-center">
                <div className="col-xl-6">
                    <div className="about-thumbs position-relative pe-lg-5">
                        <img src="/assets/images/shapes/shape7.png" alt="" className="shape seven animation-scalation" />
                        ...
                        <div className="offer-message px-24 py-12 rounded-12 bg-main-two-50 fw-medium flex-align d-inline-flex gap-16 border border-neutral-30 animation-upDown">
                            <span className="flex-shrink-0 w-48 h-48 bg-main-two-600 text-white text-2xl flex-center rounded-circle"><i className="ph ph-watch"></i></span>
                            <div>
                        ...
                        <div className="row gy-4">
                            <div className="col-sm-6">
                                <img src="/assets/images/thumbs/about-img1.png" alt="" className="rounded-12 w-100" data-tilt data-tilt-max="15" data-tilt-speed="500" data-tilt-perspective="5000" data-tilt-full-page-listening />
                            </div>
                            <div className="col-sm-6">
                                ...
                                <img src="/assets/images/thumbs/about-img2.png" alt="" className="rounded-12 w-100" data-tilt data-tilt-max="20" data-tilt-speed="500" data-tilt-perspective="5000" data-tilt-full-page-listening />
                            </div>
                        </div>
                    </div>
                </div>
                <div className="col-xl-6">
                    <div className="about-content">
                        <div className="mb-40">
                            ...
                            <h2 className="mb-24 wow bounceIn">The Place Where You Can Achieve</h2>
                        ...
                        <div className="flex-align align-items-start gap-28 mb-32" data-aos="fade-left" data-aos-duration="200">
                            ...
                            <div className="flex-grow-1">
                                ...
                                <p className="text-neutral-500">Driven by a team of dedicated educators, technologists, and visionaries, we strive to create a supportive</p>
                            </div>
                        </div>
                        <div className="flex-align align-items-start gap-28 mb-0" data-aos="fade-left" data-aos-duration="400">
                            ...
                            <div className="flex-grow-1">
                                ...
                                <p className="text-neutral-500">A professional seeking to upskill, or a lifelong learner exploring new horizons, we're here to accompany you every step of the way. </p>
                            </div>
                        </div>
                        ...
                        <div className="flex-align flex-wrap gap-32 pt-40 border-top border-neutral-50 mt-40 border-dashed border-0" data-aos="fade-left" data-aos-duration="600">
                            <a href="/course" className="btn btn-main rounded-pill flex-align gap-8">
                                Read More
