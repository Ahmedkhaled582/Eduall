    ...
    <div className="row gy-4">
        <div className="col-xl-6">
            <div className="choose-us__content">
                <div className="mb-40">
                    ...
                    <h2 className="mb-24  wow bounceIn">Our Commitment to Excellence, Learn, Grow & Success.</h2>
                ...
                <ul>
                    <li className="flex-align gap-12 mb-16" data-aos="fade-up-left"  data-aos-duration="200">
                        <span className="flex-shrink-0 text-xl text-main-600 d-flex"><i className="ph-bold ph-checks"></i></span>
                        <span className="flex-grow-1 text-neutral-500">9/10 Average Satisfaction Rate</span>
                    </li>
                    <li className="flex-align gap-12 mb-16" data-aos="fade-up-left"  data-aos-duration="400">
                        <span className="flex-shrink-0 text-xl text-main-600 d-flex"><i className="ph-bold ph-checks"></i></span>
                        <span className="flex-grow-1 text-neutral-500">96% Completitation Rate</span>
                    </li>
                    <li className="flex-align gap-12 mb-16" data-aos="fade-up-left"  data-aos-duration="500">
                        <span className="flex-shrink-0 text-xl text-main-600 d-flex"><i className="ph-bold ph-checks"></i></span>
                        <span className="flex-grow-1 text-neutral-500">Friendly Environment & Expert Teacher</span>
                    </li>
                </ul>
        ...
        <div className="col-xl-6">
            <div className="choose-us__thumbs position-relative">
                ...
                <div className="banner-box one style-two px-24 py-12 rounded-12 bg-white fw-medium box-shadow-lg d-inline-block" data-aos="fade-left">
                ...
                <div className="text-end" data-aos="zoom-out">
                    <div className="d-sm-inline-block d-block position-relative">
                        <img src="/assets/images/thumbs/choose-us-img1.png" alt="" className="choose-us__img rounded-12" data-tilt data-tilt-max="16" data-tilt-speed="500" data-tilt-perspective="5000" data-tilt-full-page-listening />
                ...
                <div className="animation-video"  data-aos="zoom-in">
                    <img src="/assets/images/thumbs/choose-us-img2.png" alt="" className="border border-white rounded-circle border-3" data-tilt />
                    <a href="https://www.youtube.com/watch?v=MFLVmAE4cqg" className="play-button w-48 h-48 flex-center bg-main-600 text-white rounded-circle text-xl position-absolute top-50 start-50 translate-middle">
